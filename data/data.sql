...
('wlos-w-pukle-nierozwity-lecz-w-wezelki-male'),
...
('jak-oblok-gdy-z-jutrzenka-napotka-sie-rana'),
...
('wyszedl-zmieszany-i-czul-ze-mu-serce-bilo'),
...
('od-dni-kilku-zbiera-sie-na-sady-graniczne'),
...
('slonce-jego-robotnik-kiedy-znijdzie-z-nieba'),
...
('wesole-lecz-w-porzadku-naprzod-dzieci-male'),
...
('przyjmowal-zwyczaj-ktorym-wszystko-oddychalo'),
...
('w-senacie-znowu-w-ziemstwie-i-guberskim-rzadzie'),
...
('ledwo-slow-kilka-wyrzekl-do-podkomorzanki'),
...
('jako-po-deszczu-zabki-na-samotnej-lace'),
...
('nalal-wegrzyna-i-rzekl-dzis-nowym-zwyczajem'),
...
('w-uczciwosci-w-grzecznosci-a-powiem-to-smialo'),
...
('a-zatem-tu-pan-sedzia-naglym-zwrotem-glowy'),
('skinal-na-tadeusza-rzucil-wzrok-surowy'),
('znac-bylo-ze-przychodzil-juz-do-wnioskow-mowy'),
('wtem-brzaknal-w-tabakiere-zlota-podkomorzy'),
('i-rzekl-moj-sedzio-dawniej-bylo-jeszcze-gorzej'),
...
('stanela-podczaszyca-dwukolna-dryndulka'),
...
('dosyc-ze-sie-nam-zdawal-malpa-lub-papuga'),
...
('milczal-bo-by-krzyczala-mlodziez-ze-przeszkadza'),
...
('choc-o-tym-dawno-w-panskim-pisano-zakonie'),
...
('bernardynskie-coz-o-tym-gadac-u-wieczerzy'),
...
('tu-rykow-przerwal-i-jadl-wtem-z-potrawa-czwarta'),
...
('(bo-nie-bylo-goraco)-wachlarz-pozlocisty'),
...
('posliznela-sie-nieco-i-w-tym-roztargnieniu'),
('na-pana-tadeusza-wsparla-sie-ramieniu'),
('przeprosiwszy-go-grzecznie-na-miejscu-swym-siadla'),
...
('poprawiala-to-lekkim-dotknieciem-sie-reki'),
...
('a-potem-sie-zaczely-wpol-glosne-rozmowy'),
...
('nie-podobna-wieczerzy-na-pozniej-odkladac'),
...
('ktorymi-przy-zachodzie-wszystko-sie-czerwieni'),
...
('ale-razem-niemala-chetke-do-swawoli'),
...
('dowiodla-ze-zna-rownie-pedzel-nuty-druki'),
...
('kogo-owa-szczesliwsza-galka-oznaczala'),
...
('jak-raz-zaczal-bez-przerwy-rzecz-swoja-tokowal'),
('i-gestami-ja-bardzo-dobitnie-malowal'),
('(byl-dawniej-adwokatem-pan-rejent-bolesta'),
('zwano-go-kaznodzieja-ze-zbyt-lubil-gesta)'),
...
('z-palcami-swymi-zabiegl-az-do-drugiej-strony'),
...
('lecz-patrzal-na-rywala-coraz-straszniej-srozej'),
...
('on-rzekl-wielmozni-szlachta-bracia-dobrodzieje'),
('forum-mysliwskim-tylko-sa-laki-i-knieje'),
...
('a-zwierze-niemajace-klow-rogow-pazurow'),
...
('przed-oczyma-rodzicow-ktorzy-te-pogonie'),
...
('mlodziez-tadeuszowi-prowadzic-kazano'),
...
('nikt-na-tym-nic-nie-stracil-a-pan-moze-zyska'),
...
('nawet-strony-przeciwne-wezmiemy-na-swiadki'),
...
('dominikanie-z-rymsza-rymsza-z-wysogirdem'),
('radziwil-z-wereszczaka-giedroic-z-rdultowskim'),
('obuchowicz-z-kahalem-juraha-z-piotrowskim'),
...
('przynosi-kosci-stare-na-ziemie-ojczysta'),
...
('jak-on-rodakow-zbiera-na-lombardzkim-polu'),
...
('i-slowa-liturgii-takim-wyrzekl-tonem'),
...
('czesto-zastanawial-sie-w-powiatowym-miescie'),
...
('a-zawsze-o-tym-co-sie-w-cudzych-krajach-dzialo'),
...
('zas-jastrzab-pod-jasnymi-wiszacy-blekity'),
('trzepie-skrzydlem-jak-motyl-na-szpilce-przybity'),
('az-ujrzawszy-wsrod-laki-ptaka-lub-zajaca'),
...
('juz-trzykroc-gegnal-gasior-a-za-nim-jak-echo'),
...
('trudno-dojrzec-szaraka-zwlaszcza-srod-kamieni'),
...
('widzac-mysliwcow-w-polu-cwalem-do-nich-pedzil'),
...
('bogacz-dobry-dla-chlopow-ludzki-dla-sasiadow'),
...
('wkolo-szyte-jedwabiem-herbowe-klejnoty'),
...
('bogacz-i-familiant-mial-jedyne-dziecie'),
...
('do-zamku-nieproszony-coraz-czesciej-jezdzil'),
...
('ledwie-byl-czas-z-mozdzierza-na-trwoge-wypalic'),
...
('w-anglii-i-w-szkocyi-kazdy-zamek-lordow'),
...
('trzepiotac-skrzydelkami-na-ktorych-sie-mieni'),
('z-rozmaitoscia-teczy-blask-drogich-kamieni'),
('tyla-farb-zywych-roznych-mak-zrenice-mami'),
...
('ktory-stopa-nadtraci-lub-dostrzeze-okiem'),
('pan-hrabia-zachwycony-tak-cudnym-widokiem'),
('stal-cicho-slyszac-tetent-towarzyszow-w-dali'),
('reka-dal-znak-azeby-wstrzymac-konie-stali'),
...
('podniesione-do-gory-wezlowate-sznurki'),
('ogorkow-chcesz-wasc-krzyknal-oto-masz-ogorki'),
...
('okiem-powrocil-w-ogrod-ale-juz-w-ogrodzie'),
('nie-bylo-jej-mignela-tylko-srod-okienka'),
('jej-rozowa-wstazeczka-i-biala-sukienka'),
('widac-na-grzedach-jaka-przeleciala-droga'),
('bo-lisc-zielony-w-biegu-potracony-noga'),
('podnosil-sie-drzal-chwile-az-sie-uspokoil'),
('jak-woda-ktora-ptaszek-skrzydlami-rozkroil'),
('a-na-miejscu-gdzie-stala-tylko-porzucony'),
('koszyk-maly-z-rokity-denkiem-wywrocony'),
('pogubiwszy-owoce-na-lisciach-zawisal'),
('i-wsrod-fali-zielonej-jeszcze-sie-kolysal'),
...
('jak-w-ulu-pustym-kiedy-wen-wlatuja-pszczoly'),
('byl-to-znak-ze-wracali-goscie-z-polowania'),
('i-krzatala-sie-sluzba-okolo-sniadania'),
('jakoz-po-wszystkich-izbach-panowal-ruch-wielki'),
('roznoszono-potrawy-sztucce-i-butelki'),
...
('przy-sniadaniach-pan-sedzia-choc-nierad-pozwalal'),
('na-taki-nieporzadek-lecz-go-nie-pochwalal'),
('rozne-tez-byly-dla-dam-i-mezczyzn-potrawy'),
...
('ktory-ma-czarnosc-wegla-przejrzystosc-bursztynu'),
('zapach-moki-i-gestosc-miodowego-plynu'),
...
('aby-kazda-z-nich-ubrac-w-osobny-kozuszek'),
('panie-starsze-juz-wczesniej-wstawszy-pily-kawe'),
('teraz-druga-dla-siebie-zrobily-potrawe'),
('z-goracego-smietana-bielonego-piwa'),
('w-ktorym-twarog-gruzlami-posiekany-plywa'),
('zas-dla-mezczyzn-wedliny-leza-do-wyboru'),
('polgeski-tluste-kumpie-skrzydliki-ozoru'),
...
('we-dwoch-izbach-dwa-rozne-skupily-sie-grona'),
('starszyzna-przy-stoliku-malym-zgromadzona'),
('mowila-o-sposobach-nowych-gospodarskich'),
...
('zabawiala-kabala-z-kart-podkomorzyne'),
('w-drugiej-izbie-toczyla-mlodziez-rzecz-o-lowach'),
('bo-asesor-i-rejent-oba-mowcy-wielcy'),
('pierwsi-znawcy-myslistwa-i-najlepsi-strzelcy'),
('siedzieli-przeciw-sobie-mrukliwi-i-gniewni'),
('oba-dobrze-poszczuli-oba-byli-pewni'),
('zwyciestwa-swoich-chartow-gdy-posrod-rowniny'),
('znalazl-sie-zagon-chlopskiej-niezzetej-jarzyny'),
('tam-wpadl-zajac-juz-kusy-juz-go-sokol-imal'),
('gdy-sedzia-dojezdzaczy-na-miedzy-zatrzymal'),
('musieli-byc-posluszni-chociaz-w-wielkim-gniewie'),
('psy-powrocily-same-i-nikt-pewnie-nie-wie'),
('czy-wpadl-w-paszcze-kusego-czyli-tez-sokola'),
('czyli-obydwu-razem-roznie-sadza-strony'),
('i-spor-na-dalsze-czasy-trwal-nierozstrzygniony'),
('wojski-stary-od-izby-do-izby-przechodzil'),
('po-obu-stronach-oczy-roztargnione-wodzil'),
('nie-mieszal-sie-w-mysliwych-ni-w-starcow-rozmowe'),
('i-widac-ze-czym-innym-zajeta-mial-glowe'),
('nosil-skorzana-placke-czasem-w-miejscu-stanie'),
('duma-dlugo-i-muche-zabije-na-scianie'),
('tadeusz-z-telimena-pomiedzy-izbami'),
('stojac-we-drzwiach-na-progu-rozmawiali-sami'),
('niewielki-oddzielal-ich-od-sluchaczow-przedzial'),
...
('choc-ja-stryj-zowie-siostra-bo-wspolni-rodzice'),
('tak-ich-kiedys-nazwali-mimo-lat-roznice'),
...
('lubil-moze-z-proznosci-nazywac-sie-bratem'),
('czego-mu-telimena-przez-przyjazn-nie-wzbrania'),
('ulzyly-tadeusza-sercu-te-wyznania'),
('wiele-tez-innych-rzeczy-sobie-oswiadczyli'),
('a-wszystko-to-sie-stalo-w-jednej-krotkiej-chwili'),
('ale-w-izbie-na-prawo-kuszac-asesora'),
('rzekl-rejent-mimojazdem-ja-mowilem-wczora'),
('ze-polowanie-nasze-udac-sie-nie-moze'),
('jeszcze-zbyt-wczesnie-jeszcze-na-pniu-stoi-zboze'),
('i-mnostwo-sznurow-chlopskiej-niezzetej-jarzyny'),
('stad-i-hrabia-nie-przybyl-mimo-zaprosiny'),
('hrabia-na-polowaniu-bardzo-dobrze-zna-sie'),
('nieraz-gadal-o-lowow-i-miejscu-i-czasie'),
('hrabia-chowal-sie-w-obcych-krajach-od-dziecinstwa'),
('i-powiada-ze-to-jest-znakiem-barbarzynstwa'),
('polowac-tak-jak-u-nas-bez-zadnego-wzgledu'),
('na-artykuly-ustaw-przepisy-urzedu'),
('nie-szanujac-niczyich-kopcow-ani-miedzy'),
('jezdzic-po-cudzym-gruncie-bez-dziedzica-wiedzy'),
('wiosna-rownie-jak-latem-zbiegac-pola-knieje'),
('zabijac-nieraz-lisa-wlasnie-gdy-linieje'),
('albo-cierpiec-iz-kotna-samice-zajecza'),
...
('znam-ja-dobrze-rosyja-panstwo-nie-wierzyli'),
('gdy-im-nieraz-mowilam-jak-tam-z-wielu-wzgledow'),
('godna-pochwaly-czujnosc-i-srogosc-urzedow'),
...
('mam-jej-portrecik-tylko-nie-chce-isc-do-biurka'),
...
('kiedy-sedzia-poczatek-powiesci-poslyszal'),
...
('niemcow-cywilizcja-porzadek-moskali'),
('niechaj-wielkopolanie-ucza-sie-od-szwabow'),
('prawowac-sie-o-lisa-i-przyzywac-drabow'),
('by-wziac-w-areszt-ogara-ze-wpadl-w-cudze-gaje'),
...
('jesli-reszty-dowodow-pana-ekonoma'),
...
('wlasnie-mu-teraz-szlachcic-nad-uchem-zadzwonil'),
...
('krotko-trwal-lecz-zrobili-wiele-w-jedna-chwile'),
...
('poprawili-juz-grozne-ucichly-odglosy'),
('nastapil-rozejm-klotni-kwestarz-ja-usmierzyl'),
('czlowiek-stary-lecz-krepy-i-bardzo-pleczysty'),
('wlasnie-kiedy-asesor-podbiegl-do-jurysty'),
('gdy-juz-sobie-gestami-grozili-szermierze'),
('on-raptem-porwal-obu-z-tylu-za-kolnierze'),
('i-dwakroc-uderzywszy-glowy-obie-mocne'),
...
('i-pax-pax-pax-vobiscum-krzyczal-pokoj-z-wami'),
('zdziwily-sie-zasmialy-nawet-strony-obie'),
('przez-szacunek-nalezny-duchownej-osobie'),
('nie-smiano-lajac-mnicha-a-po-takiej-probie'),
('nikt-tez-nie-mial-ochoty-zaczynac-z-nim-zwade'),
('zas-kwestarz-robak-skoro-uciszyl-gromade'),
('widac-bylo-ze-wcale-tryumfu-nie-szukal'),
('ani-grozil-klotnikom-wiecej-ani-fukal'),
...
('tam-uciszajac-machal-swa-placka-ze-skory'),
('wreszcie-podnioslszy-trzonek-z-powaga-do-gory'),
...
('z-gorszacej-klotni-waszej-co-bedzie-czy-wiecie'),
('oto-mlodziez-na-ktorej-ojczyzny-nadzieje'),
('ktora-ma-wslawiac-nasze-ostepy-i-knieje'),
('ktora-niestety-i-tak-zaniedbuje-lowy'),
('moze-do-ich-wzgardzenia-wezmie-pochop-nowy'),
('widzac-ze-ci-co-innym-maja-dac-przyklady'),
('z-lowow-przynosza-tylko-poswarki-i-zwady'),
('miejcie-tez-wzglad-powinny-dla-mych-wlosow-siwych'),
('bo-znalem-wiekszych-dawniej-nizli-wy-mysliwych'),
('a-sadzilem-ich-nieraz-sadem-polubownym'),
('ktoz-byl-w-lasach-litewskich-rejtanowi-rownym'),
('czy-oblawe-zaciagnac-czy-spotkac-sie-z-zwierzem'),
('kto-z-bialopiotrowiczem-porowna-sie-jerzym'),
('co-kula-z-pistoletu-w-biegu-trafial-kota'),
('terajewicza-znalem-co-idac-na-dziki'),
('nie-bral-nigdy-innego-oreza-procz-piki'),
('budrewicza-co-chodzil-z-niedzwiedziem-w-zapasy'),
('takich-mezow-widzialy-niegdys-nasze-lasy'),
('jesli-do-sporu-przyszlo-jakze-spor-godzili'),
('oto-obrali-sedziow-i-zaklad-stawili'),
('oginski-sto-wlok-lasu-raz-przegral-o-wilka'),
('niesiolowskiemu-borsuk-kosztowal-wsi-kilka'),
('i-wy-panowie-pojdzcie-za-starych-przykladem'),
('szkoda-ust-dluzej-suszyc-klotnia-o-zajaca'),
('wiec-polubownych-sedziow-najpierwej-obierzcie'),
('a-co-wyrzekna-temu-sumiennie-zawierzcie'),
('ja-uprosze-sedziego-azeby-nie-bronil'),
('dojezdzaczowi-chocby-po-pszenicy-gonil'),
...
('iz-ten-pierscien-sedziemu-w-salarijum-zloze'),
('ja-rzekl-asesor-stawie-me-zlote-obroze'),
('jaszczurem-wykladane-z-kolkami-ze-zlota'),
('i-smycz-tkany-jedwabny-ktorego-robota'),
('rownie-cudna-jak-kamien-co-sie-na-nim-swieci'),
('jeslibym-sie-ozenil-ten-sprzet-mnie-darowal'),
('ksiaze-dominik-kiedym-z-nim-razem-polowal'),
('i-z-marszalkiem-sanguszka-ksieciem-z-jeneralem'),
('mejenem-i-gdy-wszystkich-na-charty-wyzwalem'),
('tam-bezprzykladna-w-dziejach-polowania-sztuka'),
('uszczulem-szesc-zajecy-pojedyncza-suka'),
('polowalismy-wtenczas-na-kupiskim-bloniu'),
('ksiaze-radziwill-nie-mogl-dosiedziec-na-koniu'),
('zsiadl-i-objawszy-slawna-ma-charcice-kanie'),
('trzykroc-jej-w-sama-glowe-dal-pocalowanie'),
('a-potem-trzykroc-reka-klasnawszy-po-pysku'),
('rzekl-mianuje-cie-odtad-ksiezna-na-kupisku'),
('tak-napoleon-daje-wodzom-swoim-ksiestwa'),
('od-miejsc-na-ktorych-wielkie-odniesli-zwyciestwa'),
('telimena-znudzona-zbyt-dlugimi-swary'),
('chciala-wyjsc-na-dziedziniec-lecz-szukala-pary'),
('wziela-koszyczek-z-kolka-panowie-jak-widze'),
('chcecie-zostac-w-pokoju-ja-ide-na-rydze'),
('kto-laska-prosze-za-mna-rzekla-kolo-glowy'),
('obwijajac-czerwony-szal-kaszemirowy'),
('coreczke-podkomorstwa-wziela-w-jedna-reke'),
('a-druga-podchylila-do-kostek-sukienke'),
('tadeusz-milczkiem-za-nia-na-grzyby-pospieszyl'),
('zamiar-przechadzki-bardzo-sedziego-ucieszyl'),
('widzial-sposob-rozjecia-krzykliwego-sporu'),
...
('sam-ja-sobie-wybierze-jesli-znajdzie-dama'),
('najpiekniejszego-chlopca-wezmie-sobie-sama'),
...
('jako-promien-sloneczny-wykradlszy-sie-z-chmurki'),
('kiedy-srod-roli-padnie-na-krzemienia-skibe'),
('lub-srod-zielonej-laki-w-drobna-wody-szybe'),
('hrabia-zsiadl-z-konia-slugi-odprawil-do-domu'),
('a-sam-ku-ogrodowi-ruszyl-po-kryjomu'),
('dobiegl-wkrotce-parkanu-znalazl-w-nim-otwory'),
('i-wcisnal-sie-po-cichu-jak-wilk-do-obory'),
('nieszczesciem-tracil-krzaki-suchego-agrestu'),
('ogrodniczka-jak-gdyby-zlekla-sie-szelestu'),
('ogladala-sie-wkolo-lecz-nic-nie-spostrzegla'),
('przeciez-ku-drugiej-stronie-ogrodu-pobiegla'),
('a-hrabia-bokiem-miedzy-wielkie-konskie-szczawie'),
('miedzy-liscie-lopuchu-na-rekach-po-trawie'),
('skaczac-jak-zaba-cicho-przyczolgal-sie-blisko'),
('wytknal-glowe-i-ujrzal-cudne-widowisko'),
('w-tej-czesci-sadu-rosly-tu-i-owdzie-wisnie'),
('srod-nich-zboze-w-gatunkach-zmieszanych-umyslnie'),
('pszenica-kukuruza-bob-jeczmien-wasaty'),
('proso-groszek-a-nawet-krzewiny-i-kwiaty'),
('domowemu-to-ptactwu-taki-ochmistrzyni'),
('wymyslila-ogrodek-slawna-gospodyni'),
('zwala-sie-kokosznicka-z-domu-jendykowi-'),
('czowna-jej-wynalazek-epoke-stanowi'),
('w-domowym-gospodarstwie-dzis-powszechnie-znany'),
('lecz-w-owych-czasach-jeszcze-za-nowosc-podany'),
('przyjety-pod-sekretem-od-niewielu-osob'),
('nim-go-wydal-kalendarz-pod-tytulem-sposob'),
...
('szyje-nagie-do-ramion-a-pomiedzy-nimi'),
('dziewczyna-glowa-wyzsza-z-wlosami-dluzszymi'),
...
('wisiala-jak-baldachim-jasna-mgla-motylow'),
...
('przyblizyl-sie-czolgajac-jak-waz-przez-zagony'),
('az-wyskoczyl-z-lopuchu-spojrzala-stal-blisko'),
...
('siadla-przy-nim-na-ziemi-wziela-je-na-lono'),
...
('i-widocznie-byl-wdzieczny-jej-za-pochwal-tyle'),
...
('znajdziesz-wybawiciela-odtad-twym-skinieniem'),
('jak-rzadzisz-sercem-moim-tak-rzadz-mym-ramieniem'),
...
('z-dzwiecznymi-slowy-ktorych-nie-pojela-tresci'),
...
('bo-gdy-zagonem-pelzal-ku-owej-pasterce'),
...
('hrabia-z-zalamanymi-pogladal-rekoma'),
...
('wabiace-dlon-miekkimi-lekkimi-blawaty'),
...
('wiec-wypadalo-wrocic-chylac-sie-u-plotow'),
...
('patrzyl-w-strone-przeciwna-ogrodu-na-prawo'),
...
('stad-biali-wygladaja-jak-czysccowe-dusze'),
...
('ktorego-piesn-nazywa-grzybow-pulkownikiem'),
...
('*surojadki*-srebrzyste-zolte-i-czerwone'),
('niby-czareczki-roznym-winem-napelnione'),
('*kozlak*-jak-przewrocone-kubka-dno-wypukle'),
('*lejki*-jako-szampanskie-kieliszki-wysmukle'),
('*bielaki*-kragle-biale-szerokie-i-plaskie'),
('jakby-mlekiem-nalane-filizanki-saskie'),
('i-kulista-czarniawym-pylkiem-napelniona'),
('*purchawka*-jak-pieprzniczka-zas-innych-imiona'),
...
('telimena-zowiac-je-*swiatynia-dumania*'),
...
('z-glowa-na-dol-skloniona-na-dole-u-glowy'),
...
('i-nie-smiejac-isc-prosto-przysuwal-sie-bokiem'),
...
('z-wiatrem-igraly-biale-poly-sarafana'),
...
('chcialem-zagaic-na-to-telimena-zbladla'),
...
('i-coz-brat-mysli-o-tym-juzci-w-mlode-lata-'),
...
('wyslac-pomiedzy-ludzi-prosto-jak-wedrowca'),
...
('tym-lepiej-wiec-go-jako-wojazera-wyslij'),
...
('wychowanke-wacpani-oboje-dostana'),
...
('zeby-sie-to-zrobilo-najmniejszym-klopotem'),
...
('rzekla-z-gniewem-sadz-o-tym-sam-wacpan-dobrodziej'),
...
('co-wacpanstwu-do-zosi-ja-jej-reka-rzadze'),
...
('i-dotad-jeszcze-o-tym-wiadomo-na-swiecie'),
...
('chybaby-tu-zdziczala-sedzia-pilnie-sluchal'),
...
('zagaimy-swatowstwo-i-reszte-ulozym'),
('przez-ten-czas-telimena-ostygla-z-zapalu'),
('ja-nic-nie-rekuzuje-braciszku-pomalu'),
('sam-mowiles-ze-jeszcze-za-wczesnie-zbyt-mlodzi-'),
('rozpatrzmy-sie-czekajmy-nic-to-nie-zaszkodzi'),
('poznajmy-z-soba-panstwo-mlodych-bedziem-zwazac'),
...
('za-czym-sedzia-powstawszy-odszedl-zamyslony'),
...
('zmienily-ja-zaledwo-byla-do-poznania'),
('w-oczach-swiecily-jeszcze-niezagasle-gniewy'),
('twarz-ozywiona-wiatru-swiezymi-powiewy'),
...
('sadz-tu-uklakl-i-podal-swoje-pejzaze'),
...
('ktore-zewszad-skupialam-mam-ich-dosyc-w-biurku'),
...
('leszczyna-jak-menada-z-zielonymi-berly'),
('ubranymi-jak-w-grona-w-orzechowe-perly'),
...
('czy-aloes-z-dlugimi-jak-konduktor-palki'),
('czy-cytryna-karlica-z-zlocistymi-galki'),
...
('niesmiejacy-rak-podniesc-ani-glowy-skrzywic'),
('aby-sie-etykiecie-niczym-nie-sprzeciwic'),
...
('co-sie-tyczy-malarstwa-do-obrazu-trzeba'),
('punktow-widzenia-grupy-ansamblu-i-nieba'),
('nieba-wloskiego-stad-tez-w-kunszcie-pejzazow'),
('wlochy-byly-sa-beda-ojczyzna-malarzow'),
('stad-tez-oprocz-brejgela-(lecz-nie-van-der-helle'),
('ale-pejzazysty-bo-sa-dwaj-brejgele)'),
('i-oprocz-ruisdala-na-calej-polnocy'),
('gdziez-byl-pejzazysta-ktory-pierwszej-mocy'),
('niebios-niebios-potrzeba-nasz-malarz-orlowski-'),
...
('slawny-malarz-(mam-jego-kilka-szkicow-w-biurku)'),
...
('wystawial-wszystko-w-polszcze-ziemie-niebo-lasy'),
('i-mial-rozum-zawolal-tadeusz-z-zapalem-'),
('to-panstwa-niebo-wloskie-jak-o-nim-slyszalem'),
...
('hrabia-go-ucalowal-i-na-piers-przyszpilal'),
('tadeusz-z-drugiej-strony-krzak-ziela-rozchylal'),
('widzac-ze-sie-ku-niemu-tym-zielem-przewija'),
...
('i-zostalo-sie-w-domu-sedziego-wiec-z-gaju'),
('wychodzila-gromada-niosaca-krobeczki'),
('koszyki-uwiazane-koncami-chusteczki'),
('pelne-grzybow-a-panny-w-jednym-reku-niosly'),
('jako-wachlarz-zwiniony-*borowik*-rozrosly'),
('w-drugim-zwiazane-razem-jakby-polne-kwiatki'),
('*opienki*-i-rozlicznej-barwy-*surojadki*'),
('wojski-mial-*muchomora*-z-proznymi-przychodzi'),
...
('bernardyn-zmowil-krotki-pacierz-po-lacinie'),
('podano-w-kolej-wodke-za-czym-wszyscy-siedli'),
...
('obaj-pelni-nadziei-wiec-niegadatliwi'),
...
('pobiegl-do-pana-widac-z-postawy-i-z-miny'),
...
('reszte-wszyscy-odgadli-ze-zwierz-z-*matecznika*'),
...
('tasak-moj-sanguszkowski-pociagnac-na-brusku'),
...
('msze-mial-w-kaplicy-lesnej-krociuchna-oferta'),
...
('przy-ognisku-mysliwskim-na-niedzwiedziej-skorze'),
...
('przed-holowinskch-domem-nad-brzegami-rosi'),
('lipa-tak-rozrosniona-ze-pod-jej-cieniami'),
('sto-mlodziencow-sto-panien-szlo-w-taniec-parami'),
...
('wszak-lipa-czarnoleska-na-glos-jana-czula'),
...
('nikt-z-mlodziezy-nie-myslal-szukac-go-po-dworze'),
...
('myslac-o-wszystkim-co-mu-wczora-sie-zdarzylo'),
('rumienil-sie-i-wzdychal-i-serce-mu-bilo'),
('spojrzal-w-okno-o-dziwy-w-promieni-przezroczu'),
('w-owym-sercu-blyszczalo-dwoje-jasnych-oczu'),
...
('niby-srebrzyste-straczki-co-od-slonca-blasku'),
('swiecily-jak-korona-na-swietych-obrazku'),
('zerwal-sie-i-widzenie-zaraz-ulecialo'),
('przestraszone-loskotem-czekal-nie-wracalo'),
('tylko-uslyszal-znowu-trzykrotne-stukanie'),
('i-slowa-niech-pan-wstaje-czas-na-polowanie'),
('pan-zaspal-skoczyl-z-lozka-i-obu-rekami'),
('pchnal-okienice-ze-az-trzasla-zawiasami'),
('i-rozwarlszy-sie-w-obie-uderzyla-sciany'),
('wyskoczyl-patrzyl-wkolo-zdumiony-zmieszany'),
('nic-nie-widzial-nie-dostrzegl-niczyjego-sladu'),
('niedaleko-od-okna-byl-parkan-od-sadu'),
('na-nim-chmielowe-liscie-i-kwieciste-wience'),
('chwialy-sie-czy-je-lekkie-potracily-rece'),
('czy-wiatr-ruszyl-tadeusz-dlugo-patrzyl-na-nie'),
('oczy-podniosl-i-z-palcem-do-ust-przycisnionym'),
('kazal-sam-sobie-milczec-by-slowem-kwapionem'),
('nie-rozerwal-milczenia-potem-w-czolo-stukal'),
('niby-do-wspomnien-dawnych-uspionych-w-nim-pukal'),
('na-koniec-gryzac-palce-do-krwi-sie-zadrasnal'),
('i-na-caly-glos-dobrze-dobrze-mi-tak-wrzasnal'),
('we-dworze-gdzie-przed-chwila-tyle-bylo-krzyku'),
('teraz-pusto-i-glucho-jak-na-mogilniku'),
('wszyscy-ruszyli-w-pole-tadeusz-nadstawil'),
('uszu-i-rece-do-nich-jak-trabki-przyprawil'),
('sluchal-az-mu-wiatr-przyniosl-wiejacy-od-puszczy'),
('odglosy-trab-i-wrzaski-polujacej-tluszczy'),
('kon-tadeusza-czekal-w-stajni-osiodlany'),
('wzial-wiec-flinte-skoczyl-nan-i-jak-opetany'),
('pedzil-ku-karczmom-ktore-staly-przy-kaplicy'),
('kedy-mieli-sie-rankiem-zebrac-oblawnicy'),
('dwie-chylily-sie-karczmy-po-dwoch-stronach-drogi'),
('oknami-wzajem-sobie-grozace-jak-wrogi'),
('stara-nalezy-z-prawa-do-zamku-dziedzica'),
('nowa-na-zlosc-zamkowi-postawil-soplica'),
('w-tej-najwyzsze-za-stolem-bral-miejsce-protazy'),
...
('wcale-nieznany-my-go-od-zydow-dziedziczym'),
('karczma-z-przodu-jak-korab-z-tylu-jak-swiatynia'),
('korab-istna-noego-czworogranna-skrzynia'),
('znany-dzis-pod-prostackim-nazwiskiem-stodoly'),
('tam-rozne-sa-zwierzeta-konie-krowy-woly'),
('kozy-brodate-w-gorze-zas-ptactwa-gromady'),
('i-plazow-choc-po-parze-sa-tez-i-owady'),
('czesc-tylna-na-ksztalt-dziwnej-swiatyni-stawiona'),
('przypomina-z-pozoru-ow-gmach-salomona'),
('ktory-pierwsi-cwiczeni-w-budowan-rzemiesle'),
('hiramscy-na-syjonie-wystawili-ciesle'),
('zydzi-go-nasladuja-dotad-we-swych-szkolach'),
('a-szkol-rysunek-widny-w-karczmach-i-stodolach'),
('dach-z-dranic-i-ze-slomy-spiczasty-zadarty'),
('pogiety-jako-kolpak-zydowski-podarty'),
('ze-szczytu-wytryskuja-kruzganku-krawedzie'),
('oparte-na-drewnianym-licznych-kolumn-rzedzie'),
('kolumny-co-jest-wielkie-architektow-dziwo'),
('trwale-chociaz-wpol-zgnile-i-stawione-krzywo'),
('jako-w-wiezy-pizanskiej-nie-podlug-modelow'),
('greckich-bo-sa-bez-podstaw-i-bez-kapitelow'),
('nad-kolumnami-biega-wpolokragle-luki'),
('takze-z-drzewa-gotyckiej-nasladowstwo-sztuki'),
('z-wierzchu-ozdoby-sztuczne-nie-rylcem-nie-dlutem'),
('ale-zrecznie-ciesielskim-wyrzezane-sklutem'),
('krzywe-jak-szabasowych-ramiona-swiecznikow'),
('na-koncu-wisza-galki-cos-na-ksztalt-guzikow'),
('ktore-zydzi-modlac-sie-na-lbach-zawieszaja'),
('i-ktore-po-swojemu-cyces-nazywaja'),
('slowem-z-daleka-karczma-chwiejaca-sie-krzywa'),
('podobna-jest-do-zyda-gdy-sie-modlac-kiwa'),
('dach-jak-czapka-jak-broda-strzecha-roztrzesiona'),
('sciany-dymne-i-brudne-jak-czarna-opona'),
('a-z-przodu-rzezba-sterczy-jak-cyces-na-czole'),
('jedna-czesc-pelna-izbic-ciasnych-i-podluznych'),
('sluzy-dla-dam-wylacznie-i-panow-podroznych'),
('w-drugiej-ogromna-sala-kolo-kazdej-sciany'),
('ciagnie-sie-wielonozny-stol-waski-drewniany'),
('przy-nim-stolki-choc-nizsze-podobne-do-stola'),
('siedzialy-chlopy-chlopki-tudziez-szlachta-drobna'),
('wszyscy-rzedem-ekonom-sam-siedzial-z-osobna'),
('po-rannej-mszy-z-kaplicy-ze-byla-niedziela'),
('zabawic-sie-i-wypic-przyszli-do-jankiela'),
('przy-kazdym-juz-szumiala-siwa-wodka-czarka'),
('ponad-wszystkimi-z-butla-biegala-szynkarka'),
('w-srodku-arendarz-jankiel-w-dlugim-az-do-ziemi'),
('szarafanie-zapietym-haftkami-srebrnemi'),
('reke-jedna-za-czarny-pas-jedwabny-wsadzil'),
('druga-powaznie-sobie-siwa-brode-gladzil'),
('rzucajac-wkolo-okiem-rozkazy-wydawal'),
('wital-wchodzacych-gosci-przy-siedzacych-stawal'),
('zagajajac-rozmowe-klotliwych-zagadzal'),
('lecz-nie-sluzyl-nikomu-tylko-sie-przechadzal'),
('zyd-stary-i-powszechnie-znany-z-poczciwosci'),
('od-lat-wielu-dzierzawil-karczme-a-nikt-z-wlosci'),
('nikt-ze-szlachty-nie-zaniosl-nan-skargi-do-dworu'),
('o-coz-skarzyc-mial-trunki-dobre-do-wyboru'),
('rachowal-sie-ostroznie-lecz-bez-oszukanstwa'),
('ochoty-nie-zabranial-nie-cierpial-pijanstwa'),
('zabaw-wielki-milosnik-u-niego-wesele'),
('i-chrzciny-obchodzono-on-w-kazda-niedziele'),
('kazal-do-siebie-ze-wsi-przychodzic-muzyce'),
('przy-ktorej-i-basetla-byla-i-kozice'),
('muzyke-znal-sam-slynal-muzycznym-talentem'),
('z-cymbalami-narodu-swego-instrumentem'),
('chadzal-niegdys-po-dworach-i-graniem-zdumiewal'),
('i-piesniami-bo-biegle-i-uczenie-spiewal'),
('chociaz-zyd-dosyc-czysta-mial-polska-wymowe'),
('szczegolniej-zas-polubil-piesni-narodowe'),
('przywozil-mnostwo-z-kazdej-za-niemen-wyprawy'),
('kolomyjek-z-halicza-mazurow-z-warszawy'),
('wiesc-nie-wiem-czyli-pewna-w-calej-okolicy'),
('glosila-ze-on-pierwszy-przywiozl-z-zagranicy'),
('i-upowszechnil-wowczas-w-tamecznym-powiecie'),
('owa-piosenke-slawna-dzis-na-calym-swiecie'),
('a-ktora-po-raz-pierwszy-na-ziemi-auzonow'),
('wygraly-wlochom-polskie-traby-legijonow'),
('talent-spiewania-bardzo-na-litwie-poplaca'),
('jedna-milosc-u-ludzi-wslawia-i-wzbogaca'),
('jankiel-zrobil-majatek-syt-zyskow-i-chwaly'),
('zawiesil-dzwiecznostrunne-na-scianie-cymbaly'),
('przy-tym-w-pobliskim-miescie-byl-tez-podrabinkiem'),
('a-zawsze-milym-wszedzie-gosciem-i-domowym'),
('doradca-znal-sie-dobrze-na-handlu-zbozowym'),
('na-wicinnym-potrzebna-jest-znajomosc-taka'),
('na-wsi-mial-takze-slawe-dobrego-polaka'),
('on-pierwszy-zgodzil-klotnie-czesto-nawet-krwawe'),
('miedzy-dwiema-karczmami-obie-wzial-w-dzierzawe'),
('szanowali-go-rownie-i-starzy-stronnicy'),
('horeszkowscy-i-sludzy-sedziego-soplicy'),
('on-sam-powage-umial-utrzymac-nad-groznym'),
('klucznikiem-horeszkowskim-i-klotliwym-woznym'),
('przed-jankielem-tlumili-dawne-swe-urazy'),
('gerwazy-grozny-reka-jezykiem-protazy'),
('gerwazego-nie-bylo-ruszyl-na-oblawe'),
('nie-chcac-aby-tak-wazna-i-trudna-wyprawe'),
('odbyl-sam-hrabia-mlody-i-niedoswiadczony'),
('poszedl-wiec-z-nim-dla-rady-tudziez-dla-obrony'),
('dzis-miejsce-gerwazego-najdalsze-od-progu'),
('miedzy-dwiema-lawami-w-samym-karczmy-rogu'),
('zwane-*pokuciem*-kwestarz-ksiadz-robak-zajmowal'),
('jankiel-go-tam-posadzil-widac-ze-szanowal'),
('wysoko-bernardyna-bo-skoro-dostrzegal'),
('ubytek-w-jego-szklance-natychmiast-podbiegal'),
('i-rozkazal-dolewac-lipcowego-miodu'),
('slychac-ze-z-bernardynem-znali-sie-za-mlodu'),
('kedys-tam-w-cudzych-krajach-robak-czesto-chadzal'),
('noca-do-karczmy-tajnie-z-zydem-sie-naradzal'),
('o-waznych-rzeczach-slychac-bylo-ze-towary'),
('ksiadz-przemycal-lecz-potwarz-ta-niegodna-wiary'),
('robak-wsparty-na-stole-wpol-glosno-rozprawial'),
('tlum-szlachty-go-otaczal-i-uszy-nadstawial'),
('i-nosy-ku-ksiedzowskiej-chylil-tabakierze'),
('brano-z-niej-i-kichala-szlachta-jak-mozdzierze'),
('reverendissime-rzekl-kichnawszy-skoluba-'),
('to-mi-tabaka-co-to-idzie-az-do-czuba'),
('od-czasu-jak-nos-dzwigam-(tu-glasnal-nos-dlugi)'),
('takiej-nie-zazywalem-(tu-kichnal-raz-drugi)'),
('prawdziwa-bernardynka-pewnie-z-kowna-rodem'),
('miasta-slawnego-w-swiecie-tabaka-i-miodem'),
('bylem-tam-lat-juz-robak-przerwal-mu-na-zdrowie'),
('wszystkim-waszmosciom-moi-mosciwi-panowie'),
('co-sie-tabaki-tyczy-hem-ona-pochodzi'),
('z-dalszej-strony-niz-mysli-skoluba-dobrodziej'),
('pochodzi-z-jasnej-gory-ksieza-paulinowie'),
('tabake-taka-robia-w-miescie-czestochowie'),
('kedy-jest-obraz-tylu-cudami-wslawiony'),
('bogarodzicy-panny-krolowej-korony'),
('polskiej-zowia-ja-dotad-i-ksiezna-litewska-'),
('koronec-jeszcze-dotad-piastuje-krolewska'),
('lecz-na-litewskim-ksiestwie-teraz-syzma-siedzi'),
('z-czestochowy-rzekl-wilbik-bylem-tam-w-spowiedzi'),
('kiedym-na-odpust-chodzil-lat-temu-trzydziescie'),
('czy-to-prawda-ze-francuz-gosci-teraz-w-miescie'),
('ze-chce-kosciol-rozwalac-i-skarbiec-zabierze'),
('bo-to-wszystko-w-litewskim-stoi-kuryjerze'),
('nieprawda-rzekl-bernardyn-nie-pan-najjasniejszy'),
('napoleon-katolik-jest-najprzykladniejszy'),
('wszak-go-papiez-namascil-zyja-z-soba-w-zgodzie'),
('i-nawracaja-ludzi-w-francuskim-narodzie'),
('ktory-sie-troche-popsul-prawda-z-czestochowy'),
('oddano-wiele-srebra-na-skarb-narodowy'),
('dla-ojczyzny-dla-polski-sam-pan-bog-tak-kaze'),
('skarbcem-ojczyzny-zawsze-sa-jego-oltarze'),
('wszakze-w-warszawskim-ksiestwie-mamy-sto-tysiecy'),
('wojska-polskiego-moze-wkrotce-bedzie-wiecej'),
('a-ktoz-wojsko-oplaci-czy-nie-wy-litwini'),
('wy-tylko-grosz-dajecie-do-moskiewskiej-skrzyni'),
('kat-by-dal-krzyknal-wilbik-gwaltem-od-nas-biora'),
('oj-dobrodzieju-chlopek-ozwal-sie-z-pokora'),
('pokloniwszy-sie-ksiedzu-i-skrobiac-sie-w-glowe-'),
('juz-to-szlachcie-to-jeszcze-bieda-przez-polowe'),
('lecz-nas-dra-jak-na-lyka-cham-skoluba-krzyknal-'),
('glupi-tobiec-to-lepiej-tys-chlopie-przywyknal'),
('jak-wegorz-do-odarcia-lecz-nam-*urodzonym*'),
('nam-wielmoznym-do-zlotych-swobod-wzwyczajonym'),
('(tak-tak-krzykneli-wszyscy-rowny-wojewodzie)'),
('dzis-nam-szlachectwa-przecza-kaza-nam-drabowac'),
('papiery-i-szlachectwa-papierem-probowac'),
('jeszcze-waszeci-mniejsza-zawolal-juraha-'),
('waszec-z-pradziadow-chlopow-uszlachcony-szlacha'),
('ale-ja-z-kniaziow-pytac-u-mnie-o-patenta'),
('kiedym-zostal-szlachcicem-sam-bog-to-pamieta'),
('niechaj-moskal-w-las-idzie-pytac-sie-debiny'),
('kto-jej-dal-patent-rosnac-nad-wszystkie-krzewiny'),
('kniaziu-rzekl-zagiel-swiec-wasc-baki-lada-komu'),
('tu-znajdziesz-pono-mitry-i-w-niejednym-domu'),
('wasc-ma-krzyz-w-herbie-wolal-podhajski-to-skryta'),
('aluzyja-ze-w-rodzie-bywal-neofita'),
('pochodze-a-mam-krzyze-nad-herbem-korabiow'),
('poraj-krzyknal-mickiewicz-z-mitra-w-polu-zlotym'),
('herb-ksiazecy-stryjkowski-gesto-pisze-o-tym'),
('za-czym-wielkie-powstaly-w-calej-karczmie-szmery'),
('ksiadz-bernardyn-uciekl-sie-do-swej-tabakiery'),
('w-kolej-czestowal-mowcow-gwar-zaraz-ucichnal'),
('kazdy-zazyl-przez-grzecznosc-i-kilkakroc-kichnal'),
('bernardyn-korzystajac-z-przerwy-mowil-dalej'),
('oj-wielcy-ludzie-od-tej-tabaki-kichali'),
('czy-uwierzycie-panstwo-ze-z-tej-tabakiery'),
('pan-jeneral-dabrowski-zazyl-razy-cztery'),
('dabrowski-zawolali-tak-tak-on-jeneral'),
('bylem-w-obozie-gdy-on-gdansk-niemcom-odbieral'),
('mial-cos-pisac-bojac-sie-azeby-nie-zasnal'),
('zazyl-kichnal-dwakroc-mie-po-ramieniu-klasnal'),
('ksieze-robaku-mowil-ksieze-bernardynie'),
('obaczymy-sie-w-litwie-moze-nim-rok-minie'),
('powiedz-litwinom-niech-mnie-czekaja-z-tabaka'),
('czestochowska-nie-biore-innej-tylko-taka'),
('mowa-ksiedza-wzbudzila-takie-zadziwienie'),
('taka-radosc-ze-cale-huczne-zgromadzenie'),
('milczalo-chwile-potem-na-pol-ciche-slowa'),
('powtarzano-tabaka-z-polski-czestochowa'),
('dabrowski-z-ziemi-wloskiej-az-na-koniec-razem'),
('jakby-mysl-z-mysla-wyraz-sam-zbiegl-sie-z-wyrazem'),
('wszyscy-jednoglosnie-jak-na-dane-haslo'),
('krzykneli-dabrowskiego-wszystko-razem-wrzaslo'),
('wszystko-sie-uscisnelo-chlop-z-tatarskim-hrabia'),
('mitra-z-krzyzem-poraje-z-gryfem-i-z-korabia'),
('zapomnieli-wszystkiego-nawet-bernardyna'),
('tylko-spiewali-krzyczac-wodki-miodu-wina'),
('dlugo-sie-przysluchiwal-ksiadz-robak-piosence'),
('na-koniec-chcial-ja-przerwac-wzial-w-obydwie-rece'),
('tabakierke-kichaniem-melodyje-zmieszal'),
('i-nim-sie-nastroili-tak-mowic-pospieszal'),
('chwalicie-ma-tabake-mosci-dobrodzieje'),
('obaczciez-co-sie-wewnatrz-tabakierki-dzieje'),
('tu-wycierajac-chustka-zabrudzone-denko'),
('pokazal-malowana-armije-malenka'),
('jak-roj-much-w-srodku-jeden-czlowiek-na-rumaku'),
('spinal-konia-jak-gdyby-chcial-skakac-w-niebiosa'),
('jedna-reke-na-cuglach-druga-mial-u-nosa'),
('przypatrzcie-sie-rzekl-robak-tej-groznej-postawie'),
('zgadnijcie-czyja-wszyscy-patrzyli-ciekawie'),
('wielki-to-czlowiek-cesarz-ale-nie-moskali'),
('ich-carowie-tabaki-nigdy-nie-bierali'),
('wielki-czlowiek-zawolal-cydzik-a-w-kapocie'),
('ja-myslilem-ze-wielcy-ludzie-chodza-w-zlocie'),
('bo-u-moskalow-lada-jeneral-mospanie'),
('ba-przerwal-rymsza-przeciez-widzialem-za-mlodu'),
('kosciuszke-naczelnika-naszego-narodu'),
('wielki-czlowiek-a-chodzil-w-krakowskiej-sukmanie'),
('to-jest-czamarce-w-jakiej-czamarce-mospanie-'),
('odparl-wilbik-to-przeciez-zwano-taratatka'),
('ale-tamta-z-fredzlami-ta-jest-calkiem-gladka-'),
('krzyknal-mickiewicz-zatem-wszczynaly-sie-swary'),
('o-roznych-taratatki-ksztaltach-i-czamary'),
('przemyslny-robak-widzac-ze-sie-tak-rozpryska'),
('rozmowa-jal-ja-znowu-zbierac-do-ogniska'),
('do-swojej-tabakiery-czestowal-kichali'),
('zyczyli-sobie-zdrowia-on-rzecz-ciagnal-dalej'),
('gdy-cesarz-napoleon-w-potyczce-zazywa'),
('raz-po-raz-to-znak-pewny-ze-bitwe-wygrywa'),
('na-przyklad-pod-austerlitz-francuzi-tak-stali'),
('z-armatami-a-na-nich-biegla-cma-moskali'),
('cesarz-patrzyl-i-milczal-co-francuzi-strzela'),
('to-moskale-pulkami-jak-trawa-sie-sciela'),
('pulk-za-pulkiem-cwalowal-i-spadal-z-kulbaki'),
('co-pulk-spadnie-to-cesarz-zazyje-tabaki'),
('az-w-koncu-aleksander-ze-swoim-braciszkiem'),
('konstantym-i-z-niemieckim-cesarzem-franciszkiem'),
('w-nogi-z-pola-wiec-cesarz-widzac-ze-po-walce'),
('spojrzal-na-nich-zasmial-sie-i-otrzasnal-palce'),
('otoz-jesli-kto-z-panow-coscie-tu-przytomni'),
('bedzie-w-wojsku-cesarza-niech-to-sobie-wspomni'),
('ach-zawolal-skoluba-moj-ksieze-kwestarzu'),
('kiedyz-to-bedzie-wszak-to-ile-w-kalendarzu'),
('jest-swiat-na-kazde-swieto-francuzow-nam-wroza'),
('wyglada-czlek-wyglada-az-sie-oczy-mruza'),
('a-moskal-jak-nas-trzymal-tak-trzyma-za-szyje'),
('pono-nim-slonce-wnidzie-rosa-oczy-wyje'),
('mospanie-rzekl-bernardyn-babska-rzecz-narzekac'),
('a-zydowska-rzecz-rece-zalozywszy-czekac'),
('nim-kto-w-karczme-zajedzie-i-do-drzwi-zapuka'),
('z-napoleonem-pobic-moskalow-nie-sztuka'),
('juzci-on-szwabom-skore-trzy-razy-wymlocil'),
('brzydkie-prusactwo-zdeptal-anglikow-wyrzucil'),
('het-za-morze-moskalom-zapewne-wygodzi'),
('ale-co-stad-wyniknie-wie-asan-dobrodziej'),
('oto-szlachta-litewska-wtenczas-na-kon-wsiedzie'),
('i-szable-wezmie-kiedy-bic-sie-z-kim-nie-bedzie'),
('napoleon-sam-wszystkich-pobiwszy-nareszcie'),
('powie-obejde-sie-ja-bez-was-kto-jestescie'),
('wiec-nie-dosc-goscia-czekac-nie-dosc-i-zaprosic'),
('trzeba-czeladke-zebrac-i-stoly-pownosic'),
('a-przed-uczta-potrzeba-dom-oczyscic-z-smieci'),
('oczyscic-dom-powtarzam-oczyscic-dom-dzieci'),
('nastapilo-milczenie-potem-glosy-w-tlumie'),
('jakze-to-dom-oczyscic-jak-to-ksiadz-rozumie'),
('juzci-my-wszystko-zrobim-na-wszystko-gotowi'),
('tylko-niech-ksiadz-dobrodziej-jasniej-sie-wyslowi'),
('ksiadz-pogladal-za-okno-przerwawszy-rozmowe'),
('ujrzal-cos-ciekawego-z-okna-wytknal-glowe'),
('po-chwili-rzekl-powstajac-dzis-czasu-nie-mamy'),
('potem-o-tym-obszerniej-z-soba-pogadamy'),
('jutro-bede-dla-sprawy-w-powiatowym-miescie'),
('i-do-waszmosciow-z-drogi-zajade-po-kwescie'),
('niech-tez-do-niehrymowa-ksiadz-na-nocleg-zdazy-'),
('rzekl-ekonom-rad-bedzie-ksiedzu-pan-chorazy'),
('wszakze-na-litwie-stare-powiada-przyslowie'),
('szczesliwy-czlowiek-jako-kwestarz-w-niehrymowie'),
('i-do-nas-rzekl-zubkowski-wstap-jezeli-laska'),
('znajdzie-sie-tam-polsztuczek-plotna-masla-faska'),
('baran-lub-krowka-wspomnij-ksieze-na-te-slowa'),
('szczesliwy-czlowiek-trafil-jak-ksiadz-do-zubkowa'),
('i-do-nas-rzekl-skoluba-do-nas-terajewicz-'),
('zaden-bernardyn-glodny-nie-wyszedl-z-pucewicz'),
('tak-cala-szlachta-prosba-i-obietnicami'),
('przeprowadzala-ksiedza-on-juz-byl-za-drzwiami'),
('on-juz-pierwej-przez-okno-ujrzal-tadeusza'),
('ktory-lecial-goscincem-w-cwal-bez-kapelusza'),
('z-glowa-schylona-bladym-posepnym-obliczem'),
('a-konia-ustawicznie-bodl-i-kropil-biczem'),
('ten-widok-bardzo-ksiedza-bernardyna-zmieszal'),
('wiec-za-mlodziencem-kroki-szybkimi-pospieszal'),
('do-wielkiej-puszczy-ktora-jako-oko-siega'),
('czernila-sie-na-calym-brzegu-widnokrega'),
('ktoz-zbadal-puszcz-litewskich-przepastne-krainy'),
('az-do-samego-srodka-do-jadra-gestwiny'),
('rybak-ledwie-u-brzegow-nawiedza-dno-morza'),
('mysliwiec-krazy-kolo-puszcz-litewskich-loza'),
('zna-je-ledwie-po-wierzchu-ich-postac-ich-lice'),
('lecz-obce-mu-ich-wnetrzne-serca-tajemnice'),
('wiesc-tylko-albo-bajka-wie-co-sie-w-nich-dzieje'),
('bo-gdybys-przeszedl-bory-i-podszyte-knieje'),
('trafisz-w-glebi-na-wielki-wal-pniow-klod-korzeni'),
('obronny-trzesawica-tysiacem-strumieni'),
('i-siecia-zielsk-zaroslych-i-kopcami-mrowisk'),
('gniazdami-os-szerszeniow-klebami-wezowisk'),
('gdybys-i-te-zapory-zmogl-nadludzkim-mestwem'),
('dalej-co-krok-czyhaja-niby-wilcze-doly'),
('male-jeziorka-trawa-zarosle-na-poly'),
('tak-glebokie-ze-ludzie-dna-ich-nie-dosledza'),
('(wielkie-jest-podobienstwo-ze-diably-tam-siedza)'),
('woda-tych-studni-sklni-sie-plamista-rdza-krwawa'),
('a-z-wnetrza-ciagle-dymi-zionac-won-plugawa'),
('od-ktorej-drzewa-wkolo-traca-lisc-i-kore'),
('lyse-skarlowaciale-robaczliwe-chore'),
('pochyliwszy-konary-mchem-koltunowate'),
('i-pnie-garbiac-brzydkimi-grzybami-brodate'),
('siedza-wokolo-wody-jak-czarownic-kupa'),
('grzejaca-sie-nad-kotlem-w-ktorym-warza-trupa'),
('za-tymi-jeziorkami-juz-nie-tylko-krokiem'),
('ale-daremnie-nawet-zapuszczac-sie-okiem'),
('bo-tam-juz-wszystko-mglistym-zakryte-oblokiem'),
('co-sie-wiecznie-ze-trzeskich-oparzelisk-wznosi'),
('a-za-ta-mgla-na-koniec-(jak-wiesc-gminna-glosi)'),
('ciagnie-sie-bardzo-piekna-zyzna-okolica'),
('glowna-krolestwa-zwierzat-i-roslin-stolica'),
('w-niej-sa-zlozone-wszystkich-drzew-i-ziol-nasiona'),
('z-ktorych-sie-rozrastaja-na-swiat-ich-plemiona'),
('w-niej-jak-w-arce-noego-z-wszelkich-zwierzat-rodu'),
('jedna-przynajmniej-para-chowa-sie-dla-plodu'),
('w-samym-srodku-(jak-slychac)-maja-swoje-dwory'),
('dawny-tur-zubr-i-niedzwiedz-puszcz-imperatory'),
('okolo-nich-na-drzewach-gniezdzi-sie-rys-bystry'),
('i-zarloczny-rosomak-jak-czujne-ministry'),
('dalej-zas-jak-podwladni-szlachetni-wasale'),
('mieszkaja-dziki-wilki-i-losie-rogale'),
('nad-glowami-sokoly-i-orlowie-dzicy'),
('zyjacy-z-panskich-stolow-dworscy-zausznicy'),
('te-pary-zwierzat-glowne-i-patryjarchalne'),
('ukryte-w-jadrze-puszczy-swiatu-niewidzialne'),
('dzieci-swe-sla-dla-osad-za-granice-lasu'),
('a-sami-we-stolicy-uzywaja-wczasu'),
('nie-gina-nigdy-bronia-sieczna-ani-palna'),
('lecz-starzy-umieraja-smiercia-naturalna'),
('maja-tez-i-swoj-cmentarz-kedy-bliscy-smierci'),
('ptaki-skladaja-piora-czworonogi-siesrci'),
('niedzwiedz-gdy-zjadlszy-zeby-strawy-nie-przezuwa'),
('jelen-zgrzybialy-gdy-juz-ledwie-nogi-suwa'),
('zajac-sedziwy-gdy-mu-juz-krew-w-zylach-krzepnie'),
('kruk-gdy-juz-posiwieje-sokol-gdy-oslepnie'),
('orzel-gdy-mu-dziob-stary-tak-sie-w-kablak-skrzywi'),
('ze-zamkniety-na-wieki-juz-gardla-nie-zywi'),
('ida-na-cmentarz-nawet-mniejszy-zwierz-raniony'),
('lub-chory-biezy-umrzec-w-swe-ojczyste-strony'),
('nie-znajduja-sie-nigdy-martwych-zwierzat-kosci'),
('slychac-ze-tam-w-stolicy-miedzy-zwierzetami'),
('dobre-sa-obyczaje-bo-rzadza-sie-sami'),
('jeszcze-cywilizacja-ludzka-nie-popsuci'),
('nie-znaja-praw-wlasnosci-ktora-swiat-nasz-kloci'),
('nie-znaja-pojedynkow-ni-wojennej-sztuki'),
('jak-ojce-zyly-w-raju-tak-dzis-zyja-wnuki'),
('dzikie-i-swojskie-razem-w-milosci-i-zgodzie'),
('nigdy-jeden-drugiego-nie-kasa-ni-bodzie'),
('nawet-gdyby-tam-czlowiek-wpadl-chociaz-niezbrojny'),
('toby-srodkiem-bestyi-przechodzil-spokojny'),
('one-by-nan-patrzyly-tym-wzrokiem-zdziwienia'),
('jakim-w-owym-ostatnim-szostym-dniu-stworzenia'),
('ojce-ich-pierwsze-co-sie-w-ogrojcu-gniezdzily'),
('patrzyly-na-adama-nim-sie-z-nim-sklocily'),
('szczesciem-czlowiek-nie-zbladzi-do-tego-ostepu'),
('bo-trud-i-trwoga-i-smierc-bronia-mu-przystepu'),
('czasem-tylko-w-pogoni-zaciekle-ogary'),
('wpadlszy-niebacznie-miedzy-bagna-mchy-i-jary'),
('wnetrznej-ich-okropnosci-razone-widokiem'),
('uciekaja-skowyczac-z-oblakanym-wzrokiem'),
('i-dlugo-potem-reka-pana-juz-glaskane'),
('drza-jeszcze-u-nog-jego-strachem-opetane'),
('te-puszcz-stoleczne-ludziom-nieznane-tajniki'),
('w-jezyku-swoim-strzelcy-zowia-*mateczniki*'),
('glupi-niedzwiedziu-gdybys-w-mateczniku-siedzial'),
('nigdy-by-sie-o-tobie-wojski-nie-dowiedzial'),
('ale-czyli-pasieki-zwabila-cie-wonnosc'),
('czy-uczules-do-owsa-dojrzalego-sklonnosc'),
('i-tam-zaraz-lesniczy-bytnosc-twa-wysledzil'),
('i-zaraz-obsaczniki-chytre-naslal-szpiegi'),
('by-poznac-gdzie-popasasz-i-gdzie-masz-noclegi'),
('teraz-wojski-z-oblawa-juz-od-matecznika'),
('postawiwszy-szeregi-odwrot-ci-zamyka'),
('tadeusz-sie-dowiedzial-ze-niemalo-czasu'),
('juz-przeszlo-jak-ogary-wpadly-w-otchlan-lasu'),
('cicho-prozno-mysliwi-natezaja-ucha'),
('prozno-jak-najciekawszej-mowy-kazdy-slucha'),
...
('a-strzelcy-obrociwszy-do-lasu-dwururki'),
...
('dolawiaja-sie-wrzeszcza-wpadly-na-trop-graja'),
...
('i-przednimi-lapami-to-drzewa-korzenie'),
...
('hrabie-i-tadeusza-oni-bez-obawy'),
...
('(niedoswiadczeni)-razem-zagrzmialy-dwururki'),
...
('pobledli-w-tyl-skoczyli-i-gdzie-rzednie-puszcza'),
...
('i-zagral-rog-jak-wicher-wirowatym-dechem'),
...
('znowu-jakby-w-niedzwiedzie-rozwarlszy-sie-gardlo'),
...
('z-oczyma-wzniesionymi-stal-jakby-natchniony'),
...
('(slawny-tam-mieszka-slusarz-polak-ktory-robil'),
...
('czy-szerpentyna-czyli-nawet-z-pistoletu'),
...
('zwierza-na-woz-zlozyli-sami-na-kon-siedli'),
...
('przemawiali-srod-gwaru-i-wrzasku-czeredy'),
...
('konczyl-im-o-doweyce-i-domeyce-powiesc'),
...
('domeyki-i-doweyki-wszystkie-sprzeciwienstwa'),
('pochodzily-rzecz-dziwna-z-nazwisk-podobienstwa'),
('bardzo-niewygodnego-bo-gdy-w-czas-sejmikow'),
('przyjaciele-doweyki-skarbili-stronnikow'),
('szepnal-ktos-do-szlachcica-daj-kreske-doweyce'),
('a-ten-nie-doslyszawszy-dal-kreske-domeyce'),
('gdy-na-uczcie-wniosl-zdrowie-marszalek-rupejko'),
('wiwat-doweyko-drudzy-krzykneli-domeyko'),
('a-kto-siedzial-posrodku-nie-trafil-do-ladu'),
('zwlaszcza-przy-niewyraznej-mowie-w-czas-obiadu'),
('gorzej-bylo-raz-w-wilnie-jakis-szlachcic-pjany'),
('bil-sie-w-szable-z-domeyka-i-dostal-dwie-rany'),
('potem-ow-szlachcic-z-wilna-wracajac-do-domu'),
('dziwnym-trafem-z-doweyka-zjechal-sie-u-promu'),
('gdy-wiec-na-jednym-promie-plyneli-wilejka'),
('pyta-sasiada-kto-on-odpowie-doweyko-'),
('nie-czekajac-dobywa-rapier-spod-kirejki'),
('czach-czach-i-za-domeyke-podcial-was-doweyki'),
...
('bo-taki-spor-nie-moze-skonczyc-sie-na-niczym'),
...
('zgoda-wrzasli-czas-jutro-miejsce-karczma-usza'),
...
('bez-smyczy-szly-przy-koniach-gdy-kota-spostrzegly'),
...
('ze-zajac-psy-i-charty-jedne-tworza-cialo'),
...
('i-konczyl-rzecz-przerwana-na-czym-wiec-stanalem'),
('aha-na-tym-ze-obu-za-slowo-ujalem'),
...
('postawilem-doweyke-na-zwierza-ogonie'),
('z-jednej-strony-domeyke-zas-po-drugiej-stronie'),
...
('nuz-im-z-ewangelii-z-statutow-dowodzic'),
('nie-ma-rady-smieli-sie-i-musieli-zgodzic'),
('spor-ich-potem-w-dozgonna-przyjazn-sie-zamienil'),
('i-doweyko-sie-z-siostra-domeyki-ozenil'),
('domeyko-pojal-siostre-szwagra-doweykowne'),
...
('siedzi-z-zalozonymi-na-piersiach-rekoma'),
...
('juz-troche-zakochany-coz-moze-sie-zmienic'),
('potem-czy-szczerze-kocha-czy-sie-zechce-zenic'),
('z-kobieta-kilku-laty-starsza-niebogata'),
('czy-mu-krewni-pozwola-co-swiat-powie-na-to'),
('telimena-tak-myslac-z-sofy-sie-podniosla'),
('i-stanela-na-palcach-rzeklbys-ze-podrosla'),
('odkryla-nieco-piersi-wygiela-sie-bokiem'),
('i-sama-siebie-pilnym-obejrzala-okiem'),
('i-znowu-zapytala-o-rade-zwierciadla'),
('po-chwili-wzrok-spuscila-westchnela-i-siadla'),
('hrabia-pan-zmienni-w-gustach-sa-ludzie-majetni'),
('hrabia-blondyn-blondyni-nie-sa-zbyt-namietni'),
('a-tadeusz-prostaczek-poczciwy-chlopczyna'),
('prawie-dziecko-raz-pierwszy-kochac-sie-zaczyna'),
('pilnowany-nielacno-zerwie-pierwsze-zwiazki'),
('przy-tym-dla-telimeny-ma-juz-obowiazki'),
('mezczyzni-poki-mlodzi-chociaz-w-myslach-zmienni'),
('w-uczuciach-sa-od-dziadow-stalsi-bo-sumienni'),
('dlugo-serce-mlodzienca-proste-i-dziewicze'),
('chowa-wdziecznosc-za-pierwsze-milosci-slodycze'),
('ono-rozkosz-i-wita-i-zegna-z-weselem'),
('jak-skromna-uczte-ktora-dzielim-z-przyjacielem'),
('tylko-stary-pjanica-gdy-juz-spali-trzewa'),
('brzydzi-sie-trunkiem-ktorym-nazbyt-sie-zalewa'),
('wszystko-to-telimena-dokladnie-wiedziala'),
('bo-i-rozum-i-wielkie-doswiadczenie-miala'),
('lecz-co-powiedza-ludzie-mozna-im-zejsc-z-oczu'),
('w-inne-strony-wyjechac-mieszkac-na-uboczu'),
('lub-co-lepsza-wyniesc-sie-calkiem-z-okolicy'),
('na-przyklad-zrobic-mala-podroz-do-stolicy'),
('mlodego-chlopca-na-swiat-wielki-wyprowadzic'),
('kroki-jego-kierowac-pomagac-mu-radzic'),
('serce-mu-ksztalcic-miec-w-nim-przyjaciela-brata'),
('nareszcie-uzyc-swiata-poki-sluza-lata'),
('tak-myslac-po-alkowie-smialo-i-wesolo'),
('przeszla-sie-kilka-razy-znow-spuscila-czolo'),
('warto-by-tez-pomyslic-o-hrabiego-losie'),
('czyby-sie-nie-udalo-podsunac-mu-zosie'),
('niebogata-lecz-za-to-urodzeniem-rowna'),
('z-domu-senatorskiego-jest-dygnitarzowna'),
('jezeliby-do-skutku-przyszlo-ozenienie'),
('telimena-w-ich-domu-mialaby-schronienie'),
('na-przyszlosc-krewna-zosi-i-hrabiego-swatka'),
('dla-mlodego-malzenstwa-bylaby-jak-matka'),
('po-tej-z-soba-odbytej-stanowczej-naradzie'),
('wola-przez-okno-zosie-bawiaca-sie-w-sadzie'),
('zosia-w-porannym-stroju-i-z-glowa-odkryta'),
('stala-trzymajac-w-reku-podniesione-sito'),
('do-nog-jej-bieglo-ptastwo-stad-kury-szurpate'),
('tocza-sie-klebkiem-stamtad-kogutki-czubate'),
('wstrzasajac-koralowe-na-glowach-szyszaki'),
('i-wioslujac-skrzydlami-przez-bruzdy-i-krzaki'),
('szeroko-wyciagaja-ostrozaste-piety'),
('za-nimi-z-wolna-indyk-sunie-sie-odety'),
('sarkajac-na-gderanie-swej-krzykliwej-zony'),
('owdzie-pawie-jak-tratwy-dlugimi-ogony'),
('steruja-sie-po-lace-a-gdzieniegdzie-z-gory'),
('upada-jak-kisc-sniegu-golab-srebrnopiory'),
('w-posrodku-zielonego-okregu-murawy'),
('sciska-sie-okrag-ptastwa-krzykliwy-ruchawy'),
('opasany-golebi-sznurem-na-ksztalt-wstegi'),
('tu-dzioby-bursztynowe-tam-czubki-z-korali'),
('wznosza-sie-z-gestwi-pierza-jak-ryby-spod-fali'),
('wysuwaja-sie-szyje-i-w-ruchach-lagodnych'),
('chwieja-sie-ciagle-na-ksztalt-tulipanow-wodnych'),
('tysiace-oczu-jak-gwiazd-blyskaja-ku-zosi'),
('ona-w-srodku-wysoko-nad-ptastwem-sie-wznosi'),
('sama-biala-i-w-dluga-bielizne-ubrana'),
('kreci-sie-jak-bijaca-srod-kwiatow-fontanna'),
('czerpie-z-sita-i-sypie-na-skrzydla-i-glowy'),
('reka-jak-perly-biala-gesty-grad-perlowy'),
('krup-jeczmiennych-to-ziarno-godne-panskich-stolow'),
('robi-sie-dla-zaprawy-litewskich-rosolow'),
('zosia-je-wykradajac-z-szafy-ochmistrzyni'),
('dla-swego-drobiu-szkode-w-gospodarstwie-czyni'),
('uslyszala-wolanie-zosiu-to-glos-cioci'),
('sypnela-razem-ptastwu-ostatek-lakoci'),
('a-sama-krecac-sito-jako-tanecznica'),
('bebenek-i-w-takt-bijac-swawolna-dziewica'),
('jela-skakac-przez-pawie-golebie-i-kury'),
('zmieszane-ptastwo-tlumnie-furknelo-do-gory'),
('zosia-stopami-ledwie-dotykajac-ziemi'),
('zdawala-sie-najwyzej-bujac-miedzy-niemi'),
('przodem-golebie-biale-ktore-w-biegu-ploszy'),
('lecialy-jak-przed-wozem-bogini-rozkoszy'),
('zosia-przez-okno-z-krzykiem-do-alkowy-wpadla'),
('i-na-kolanach-ciotki-zadyszana-siadla'),
('telimena-calujac-i-glaszczac-pod-brode'),
('z-radoscia-zwaza-dziecka-zywosc-i-urode'),
('(bo-prawdziwie-kochala-swa-wychowanice)'),
('ale-znowu-powaznie-nastroila-lice'),
('wstala-i-przechodzac-sie-wszerz-i-wzdluz-alkowy'),
('dzierzac-palec-przy-ustach-tymi-rzekla-slowy'),
('kochana-zosiu-juz-tez-calkiem-zapominasz'),
('i-na-stan-i-na-wiek-twoj-wszak-to-dzis-zaczynasz'),
('rok-czternasty-czas-rzucic-indyki-i-kurki'),
('fi-to-godna-zabawka-dygnitarskiej-corki'),
('i-z-umurzana-dziatwa-chlopska-juz-do-woli'),
('napiescilas-sie-zosiu-patrzac-serce-boli'),
('opalilas-okropnie-plec-czysta-cyganka'),
('a-chodzisz-i-ruszasz-sie-jak-parafijanka'),
('juz-ja-temu-wszystkiemu-na-przyszlosc-zaradze'),
('od-dzis-zaczne-dzis-ciebie-na-swiat-wyprowadze'),
('do-salonu-do-gosci-gosci-mamy-sila'),
('patrzajzez-azebys-mnie-wstydu-nie-zrobila'),
('zosia-skoczyla-z-miejsca-i-klasnela-w-dlonie'),
('i-ciotce-zawisnawszy-oburacz-na-lonie'),
('plakala-i-smiala-sie-na-przemian-z-radosci'),
('ach-ciociu-juz-tak-dawno-nie-widzialam-gosci'),
('od-czasu-jak-tu-zyje-z-kury-i-indyki'),
('jeden-gosc-co-widzialam-to-byl-golab-dziki'),
('juz-mi-troszeczke-nudno-tak-siedziec-w-alkowie'),
('pan-sedzia-nawet-mowi-ze-to-zle-na-zdrowie'),
('sedzia-przerwala-ciotka-ciagle-mi-dokuczal'),
('zeby-cie-na-swiat-wywiesc-ciagle-pod-nos-mruczal'),
('ze-juz-jestes-dorosla-sam-nie-wie-co-plecie'),
('dziadus-nigdy-na-wielkim-niebywaly-swiecie'),
('ja-wiem-lepiej-jak-dlugo-trzeba-sie-sposobic'),
('panience-by-wyszedlszy-na-swiat-efekt-zrobic'),
('wiedz-zosiu-ze-kto-rosnie-na-widoku-ludzi'),
('choc-piekny-choc-rozumny-efektow-nie-wzbudzi'),
('gdy-go-wszyscy-przywykna-widziec-od-malenka'),
('lecz-niechaj-uksztalcona-dorosla-panienka'),
('nagle-ni-stad-ni-zowad-przed-swiatem-zablysnie'),
('wtenczas-kazdy-sie-do-niej-przez-ciekawosc-cisnie'),
('wszystkie-jej-ruchy-rzuty-oczu-jej-uwaza'),
('slowa-jej-podsluchiwa-i-drugim-powtarza'),
('a-kiedy-wejdzie-w-mode-raz-mloda-osoba'),
('kazdy-ja-chwalic-musi-choc-i-nie-podoba'),
('znalezc-sie-spodziewam-sie-ze-umiesz-w-stolicy'),
('uroslas-choc-dwa-lata-mieszkasz-w-okolicy'),
('nie-zapomnialas-jeszcze-calkiem-petersburka'),
('no-zosiu-toalete-rob-dostan-tam-z-biurka'),
('nagotowane-znajdziesz-wszystko-do-ubrania'),
('spiesz-sie-bo-lada-chwila-wroca-z-polowania'),
('wezwano-pokojowe-i-sluzaca-dziewke'),
('w-naczynie-srebrne-wody-wylano-konewke'),
('zosia-jak-wrobel-w-piasku-trzepioce-sie-myje'),
('z-pomoca-slugi-rece-oblicze-i-szyje'),
('telimena-otwiera-petersburskie-sklady'),
('dobywa-flaszki-perfum-sloiki-pomady'),
('pokrapia-zosie-wkolo-wyborna-perfuma'),
('(won-napelnila-izbe)-wlos-namaszcza-guma'),
('zosia-kladnie-ponczoszki-biale-azurowe'),
('i-trzewiki-warszawskie-biale-atlasowe'),
('tymczasem-pokojowa-sznurowala-stanik'),
('potem-rzucila-na-gors-pannie-pudermanik'),
('zaczeto-przypieczone-zbierac-papiloty'),
('pukle-ze-nazbyt-krotkie-uwito-w-dwa-sploty'),
('zostawujac-na-czole-i-skroniach-wlos-gladki'),
('pokojowa-zas-swiezo-zebrane-blawatki'),
('uwiazawszy-w-plecionke-daje-telimenie'),
('ta-ja-do-glowy-zosi-przyszpila-uczenie'),
...
('niz-z-tym-co-u-nas-dotad-goscilo-plugastwem'),
...
('widzac-ze-bladnie-i-ze-na-nogach-sie-slania'),
...
('powstala-zagniewana-i-ostrymi-slowy'),
...
('trzasnawszy-drzwi-za-soba-szczesciem-ze-tej-sceny'),
...
('z-wieku-mu-i-z-urzedu-ten-zaszczyt-nalezy'),
('idac-klanial-sie-damom-starcom-i-mlodziezy'),
('kwestarz-nie-byl-u-stolu-miejsce-bernardyna'),
...
('postrzegaja-ze-wyszli-z-niej-z-niewielka-slawa'),
...
('coz-o-tym-beda-gadac-w-oszmianie-i-lidzie'),
...
('coraz-ku-telimenie-groznym-okiem-blysnie'),
...
('czy-jakos-na-obliczu-przetarl-sie-z-trafunku-'),
...
('okolo-ust-szczegolnie-widne-byly-piegi'),
...
('dwoch-zebow-brakuje-w-ustach-na-czole-na-skroni'),
...
('takie-robiac-sam-w-sobie-wyrzuty-i-skargi'),
...
('o-jakims-niespodzianym-w-ogrodzie-spotkaniu'),
('o-jakims-po-lopuchach-i-grzedach-stapaniu'),
...
('dwoistym-zadlem-ziolo-zatrute-wypija'),
...
('w-najweselszym-zebraniu-niech-sie-kilku-gniewa'),
...
('przywykl-zeby-mu-zawsze-cos-bebnilo-w-uchu'),
...
('ani-uwazal-co-tam-szepcza-po-kryjomu'),
...
('skora-ta-rozrzadzimy-wedle-naszej-woli'),
...
('tamten-psiarnie-zawolal-ow-zwierza-nawrocil'),
...
('wiec-spolia-opima-wezmiesz-mosci-hrabia'),
...
('a-przy-tym-zawisc-ktora-czul-dla-tadeusza'),
...
('zadzwonil-w-tabakierke-zlota-o-glos-prosi'),
...
('gerwazy-nie-przybral-sie-machiny-naprawic'),
...
('bracie-rzekl-odloz-nieco-twa-pilna-robote'),
...
('ptak-sztucznie-wyrobiony-szkoda-ze-zepsuty'),
('zajakal-sie-i-piszczal-im-dalej-tym-gorzej'),
...
('za-drzwi-z-nim-podkomorzy-krzyknal'),
('zawolal-klucznik-widzisz-pan-co-sie-wyrabia'),
('czy-nie-dosyc-sie-jeszcze-panski-honor-plami'),
('ze-pan-jadasz-i-pijasz-z-tymi-soplicami'),
('trzebaz-jeszcze-aby-mnie-zamku-urzednika'),
('gerwazego-rembajle-horeszkow-klucznika'),
('lzyc-w-domu-panow-moich-i-panze-to-zniesie'),
('wtem-protazy-zawolal-trzykroc-uciszcie-sie'),
('na-ustep-ja-protazy-baltazar-brzechalski'),
('dwojga-imion-general-niegdys-trybunalski'),
('vulgo-wozny-woznienska-obdukcyja-robie'),
...
('kto-ma-na-starca-skarge-niech-mi-ja-przelozy'),
...
('do-widzenia-po-trzezwu-pojdz-za-mna-gerwazy'),
...
('rzeklbys-ze-z-winem-ognia-w-dusze-sie-nalalo'),
...
('na-mnie-to-zdajcie-ja-go-nalezycie-skarce'),
...
('wstrzymali-sie-gerwazy-z-wolna-ustepowal'),
...
('z-wypieta-na-przod-piersia-z-podniesiona-noga'),
('mial-wpasc-ujrzal-wojskiego-uczul-w-sercu-trwoge'),
('wojski-cicho-siedzacy-z-przymruzonym-okiem'),
...
('cofa-sie-ku-drzwiom-lapaj-krzyknela-gromada'),
...
('trzaslo-ciche-polkurcze-wilk-zna-je-po-trzasku'),
...
('lapaj-krzykniono-znowu-tryumf-byl-nie-dlugi'),
...
('miedzy-licznymi-kurczat-i-jendykow-cialy'),
...
('zgromadzac-sie-zaklete-maja-nieboszczyki'),
...
('ale-na-drugim-pietrze-w-izbie-ktora-zwano'),
('choc-byla-bez-zwierciadel-sala-zwierciadlana'),
...
('gerwazy-chodzil-kroki-wielkimi-po-sali'),
...
('gdym-w-sycylii-bawil-u-pewnego-ksiecia'),
...
('wdzieczna-zbawcy-ze-lzami-padla-w-me-objecia'),
('gdym-przybyl-do-palermo-wiedziano-z-gazety'),
('palcami-wskazywaly-mie-wszystkie-kobiety'),
('nawet-wydrukowano-o-calym-zdarzeniu'),
('romans-gdzie-wymieniony-jestem-po-imieniu'),
('romans-ma-tytul-polak-czyli-tajemnice'),
('zamku-birbante-rokka-czy-sa-tu-ciemnice'),
('w-tym-zamku-sa-rzekl-klucznik-ogromne-piwnice'),
('ale-puste-bo-wino-wypili-soplice'),
('dzokejow-dodal-hrabia-uzbroic-we-dworze'),
('z-wlosci-wezwac-wasalow-lokajow-bron-boze-'),
...
('ciaza-mu-coraz-bardziej-powieki-brzemienne'),
...
('z-podniesionym-nad-glowa-rapierem-straszliwym'),
('leci-rozpieta-na-wiatr-szumi-taratatka'),
('z-lewego-ucha-spadla-w-tyl-konfederatka'),
...
('i-kurtke-ktorej-poly-podpiete-na-guzy'),
...
('ale-jeszcze-raz-zgodze-zgodzic-coz-to-znaczy'),
...
('nie-narobili-jeszcze-w-tym-zamku-dosc-zlego'),
...
('slyszales-pewnie-o-czym-juz-gadaja-wszedzie'),
...
('daje-na-klasztor-ksieze-tys-sie-wczoraj-palil'),
('do-mojego-kasztanka-i-gniadosza-chwalil'),
('dzis-zaraz-w-tym-kwestarskim-wozie-pojda-oba'),
...
('gdy-dzialac-trzeba-dzialac-coz-sedzia-zapytal'),
...
('bog-swiadkiem-zem-niewinien-grzechow-mego-brata'),
...
('i-stad-to-w-czasie-bitew-zajazdow-tradowan'),
...
('widac-ze-sie-uzbrajal-lezaly-dwururki'),
('i-sztucce-na-podlodze-dalej-sztenfle-kurki'),
('i-narzedzia-slusarskie-ktorymi-rynsztunki'),
...
('i-zna-zboze-a-nawet-przedza-w-rekawiczkach'),
...
('jesli-ktory-z-nich-dziecku-imie-na-chrzcie-daje'),
...
('brala-rowniez-przydomki-zwane-*imioniska*'),
...
('calej-rodziny-zwan-byl-*kurkiem-na-kosciele*'),
('odmieniwszy-przydomek-ochrzcil-sie-*zabokiem*'),
('toz-*krolikiem*-dobrzynscy-mianuja-go-sami'),
('a-litwini-nazwali-*mackiem-nad-mackami*'),
...
('na-ziemi-nieswieconej-znac-ze-tu-chowano'),
...
('ktorymi-mozna-smialo-cwieki-obciac-z-glowek'),
('nade-drzwiami-dobrzynskich-widne-byly-herby'),
('lecz-armature-serow-zaslonily-polki'),
...
('slychac-krzyk-w-karczmie-widac-w-plebanii-swiece'),
...
('nazywany-byl-dawniej-*kurkiem-na-kosciele*'),
...
('owszem-chcial-sie-go-pozbyc-klientow-swych-fukal'),
...
('wyniosl-traw-liscia-usiadl-przed-domem-i-swisnal'),
('na-ten-swist-roj-krolikow-spod-ziemi-wytrysnal'),
('jako-narcyzy-nagle-wykwitle-nad-trawe'),
('biela-sie-dlugie-sluchy-pod-nimi-jaskrawe'),
('przeswiecaja-sie-oczki-jak-krwawe-rubiny'),
('gesto-wszyte-w-aksamit-zielonej-darniny'),
('juz-kroliki-na-lapkach-staja-kazdy-slucha'),
('patrzy-na-koniec-cala-trzodka-bialopucha'),
('biezy-do-starca-liscmi-kapusty-znecona'),
('do-nog-mu-na-kolana-skacze-na-ramiona'),
('on-sam-bialy-jak-krolik-lubi-ich-gromadzic'),
('wkolo-siebie-i-reka-cieply-ich-puch-gladzic'),
('a-druga-reka-z-czapki-proso-w-trawe-miota'),
('dla-wroblow-spada-z-dachow-krzykliwa-holota'),
('gdy-sie-staruszek-bawil-widokiem-biesiady'),
('nagle-kroliki-znikly-w-ziemi-a-gromady'),
('wroblow-na-dach-uciekly-przed-goscmi-nowymi'),
('ktorzy-szli-do-folwarku-krokami-predkiemi'),
('byli-to-z-plebanii-przez-szlachty-gromade'),
('poslowie-wyprawieni-do-macka-po-rade'),
('z-dala-witajac-starca-niskimi-uklony'),
('rzekli-niech-bedzie-jezus-chrystus-pochwalony'),
('na-wieki-wiekow-amen-starzec-odpowiedzial'),
('a-gdy-sie-o-waznosci-poselstwa-dowiedzial'),
('prosi-do-chaty-weszli-zasiadaja-lawe'),
('tymczasem-szlachty-coraz-gesciej-przybywalo'),
('dobrzynscy-prawie-wszyscy-sasiadow-niemalo'),
('z-okolicznych-zasciankow-zbrojni-i-bezbronni'),
...
('inni-sluchaja-w-okna-glowami-wcisnieni'),
('z-kolei-bartek-posel-rzecz-swa-wyprowadzal'),
('ten-ze-czesto-na-strugach-do-krolewca-chadzal'),
('nazwany-byl-prusakiem-od-swych-spolrodakow'),
('przez-zart-bo-nienawidzil-okropnie-prusakow'),
('choc-lubil-o-nich-gadac-czlek-podeszly-w-lata'),
('w-podrozach-swych-dalekich-wiele-zwiedzil-swiata'),
('gazet-pilny-czytelnik-polityki-swiadom'),
('w-niebytnosc-macka-zwykle-przewodzil-obradom'),
('bracie-moj-a-nas-wszystkich-ojcze-dobrodzieju'),
('nie-jest-to-marna-pomoc-ja-bym-na-francuzow'),
('spuscil-sie-w-czasie-wojny-jak-na-czterech-tuzow'),
('lud-bitny-a-od-czasow-pana-tadeusza'),
('kosciuszki-swiat-takiego-nie-mial-genijusza'),
('wojennego-jak-wielki-cesarz-bonaparte'),
('pamietam-kiedy-przeszli-francuzi-przez-warte'),
('bawilem-za-granica-wtenczas-w-roku-panskim'),
('tysiacznym-osimsetnym-szostym-wlasnie-z-gdanskiem'),
('handlowalem-a-krewnych-mam-wiele-w-poznanskiem'),
('jezdzilem-ich-odwiedzic-wiec-z-panem-jozefem'),
('grabowskim-ktory-teraz-jest-rejmentu-szefem'),
('a-podowczas-zyl-na-wsi-blisko-obiezierza'),
('polowalismy-sobie-na-malego-zwierza'),
('byl-pokoj-w-wielkopolszcze-jak-teraz-na-litwie'),
('wtem-nagle-rozeszla-sie-wiesc-o-strasznej-bitwie'),
('przybiegl-do-nas-poslaniec-od-pana-towdena'),
('grabowski-list-przeczytal-krzyknal-jena-jena'),
('zbito-prusakow-na-leb-na-szyje-wygrana'),
('ja-z-konia-zsiadlszy-zaraz-padlem-na-kolana'),
('dziekujac-panu-bogu-do-miasta-jedziemy'),
('niby-dla-interesu-niby-nic-nie-wiemy'),
('az-tu-widzimy-wszystkie-landraty-hofraty'),
('komisarze-i-wszystkie-podobne-psubraty'),
('klaniaja-sie-nam-nisko-kazdy-drzy-blednieje'),
('jako-owad-prusaczy-gdy-wrzatkiem-kto-zleje'),
('my-smiejac-sie-trac-rece-prosim-unizenie'),
('o-nowinki-pytamy-co-slychac-o-jenie'),
('tu-ich-strach-zdjal-dziwia-sie-ze-o-klesce-owej'),
('juz-wiemy-krzycza-niemcy-achary-got-o-wej'),
('spusciwszy-nos-do-domow-z-domow-dalej-w-nogi-'),
('o-to-byl-rwetes-wszystkie-wielkopolskie-drogi'),
('pelne-uciekajacych-niemczyska-jak-mrowie'),
('pelzna-ciagna-pojazdy-ktore-lud-tam-zowie'),
('wageny-i-fornalki-mezczyzni-kobiety'),
('z-fajkami-z-imbryczkami-wleka-pudla-bety'),
('drapia-jak-moga-a-my-milczkiem-wchodzim-w-rade'),
('hejze-na-kon-pomieszac-niemcom-rejterade'),
('a-herow-oficerow-lowic-za-harcaby'),
...
('gdyby-sie-tak-obrocic-i-gracko-i-raznie'),
('i-u-nas-w-litwie-sprawic-moskwie-taka-laznie'),
('he-co-myslisz-macieju-jesli-z-bonapartem'),
('moskwa-drze-koty-to-on-wojuje-nie-zartem'),
('bohater-pierwszy-w-swiecie-a-wojsk-ma-bez-liku'),
('he-coz-myslisz-macieju-nasz-ojcze-kroliku'),
('skonczyl-czekaja-wszyscy-macieja-wyroku'),
('maciej-glowy-nie-ruszyl-ani-podniosl-wzroku'),
('tylko-reka-kilkakroc-uderzyl-po-boku'),
('jak-gdyby-szabli-szukal-(od-zaboru-kraju'),
('szabli-nie-nosil-przeciez-z-dawnego-zwyczaju'),
('na-wspomnienie-moskala-zawsze-reke-zwracal'),
('na-lewy-bok-zapewne-rozeczki-swej-macal'),
('i-stad-byl-nazywany-powszechnie-*zabokiem*'),
('juz-wzniosl-glowe-sluchaja-w-milczeniu-glebokiem'),
('maciej-oczekiwanie-powszechne-omylil'),
('nachmurzyl-brwi-i-znowu-glowe-na-piers-schylil'),
('na-koniec-odezwal-sie-z-wolna-kazde-slowo'),
('wymawiajac-z-przyciskiem-a-w-takt-kiwal-glowa'),
('cicho-skadze-ta-cala-nowina-pochodzi'),
('jak-daleko-francuzi-kto-nimi-dowodzi'),
('czy-juz-wojne-zaczeli-z-moskwa-gdzie-i-o-co'),
('ktoredy-maja-ciagnac-z-jaka-ida-moca'),
('wiele-piechoty-jazdy-kto-wie-niechaj-gada'),
('milczala-patrzac-na-sie-kolejno-gromada'),
('radzilbym-rzecze-prusak-czekac-bernardyna'),
('robaka-bo-od-niego-pochodzi-nowina'),
('tymczasem-poslac-pewnych-szpiegow-nad-granice'),
('i-po-cichu-uzbrajac-cala-okolice'),
('a-tymczasem-ostroznie-cala-rzecz-prowadzic'),
('aby-moskalom-naszych-zamiarow-nie-zdradzic'),
('he-czekac-szczekac-zwlekac-przerwal-maciej-drugi'),
('ochrzczony-kropicielem-od-wielkiej-maczugi'),
('ktora-zwal-kropidelkiem-mial-ja-dzis-przy-sobie'),
('stanal-za-nia-na-galce-zwiesil-rece-obie'),
('na-reku-oparl-brode-krzyczac-czekac-zwlekac'),
('sejmikowac-hem-trem-brem-a-potem-uciekac'),
('ja-w-prusach-nie-bywalem-rozum-krolewiecki'),
('dobry-dla-prus-a-u-mnie-jest-rozum-szlachecki'),
('to-wiem-ze-kto-chce-bic-sie-niech-kropidlo-chwyta'),
('kto-umierac-ten-ksiedza-niech-wola-i-kwita'),
('ja-chce-zyc-bic-bernardyn-po-co-czy-my-zaki'),
('co-mi-tam-robak-otoz-my-bedziem-robaki'),
('i-dalej-moskwe-toczyc-trem-brem-szpiegi-wzwiady'),
('wiecie-wy-co-to-znaczy-oto-ze-wy-dziady'),
('niedolegi-he-bracia-to-wyzla-rzecz-tropic'),
('bernardynska-kwestowac-a-moja-rzecz-kropic'),
('kropic-kropic-i-kwita-tu-maczuge-glasnal'),
('za-nim-caly-tlum-szlachty-kropic-kropic-wrzasnal'),
('poparl-strone-chrzciciela-bartek-zwan-brzytewka'),
('od-szabli-cienkiej-tudziez-maciej-zwan-konewka'),
('od-sztucca-ktory-naszal-z-gardlem-tak-szerokiem'),
('ze-zen-jak-z-konwi-tuzin-kulek-lal-potokiem'),
('oba-krzyczeli-wiwat-chrzciciel-z-kropidelkiem'),
('prusak-chcial-mowic-ale-zgluszono-go-zgielkiem'),
('i-smiechem-precz-wolano-precz-prusaki-tchorze'),
('wtem-znowu-glowe-z-wolna-podniosl-maciej-stary'),
('i-zaczely-cokolwiek-uciszac-sie-gwary'),
('ten-robaczek-wiekszego-od-was-zgryzl-orzecha'),
('raz-go-tylko-widzialem-ledwiem-okiem-rzucil'),
('poznalem-co-za-ptaszek-ksiadz-oczy-odwrocil'),
('lekajac-sie-zebym-go-nie-zaczal-spowiadac'),
('ale-to-rzecz-nie-moja-wiele-o-tym-gadac'),
('on-tu-nie-przyjdzie-prozno-wzywac-bernardyna'),
('jesli-od-niego-wyszla-ta-cala-nowina'),
('to-kto-wie-w-jakim-celu-bo-to-bies-ksiezyna'),
('jesli-procz-tej-nowiny-nic-wiecej-nie-wiecie'),
('wiec-po-coscie-tu-przyszli-i-czego-wy-chcecie'),
('wojny-krzykneli-jakiej-spytal-zawolali'),
('wojny-z-moskalem-bic-sie-hejze-na-moskali'),
('prusak-wciaz-wolal-a-glos-coraz-wyzej-wznosil'),
('az-posluchanie-czescia-uklonem-wyprosil'),
('czescia-zdobyl-swa-mowa-krzykliwa-i-cienka'),
('i-ja-chce-bic-sie-wolal-tlukac-sie-w-piers-reka-'),
('choc-kropidla-nie-nosze-dragiem-od-wiciny'),
('sprawilem-raz-prusakom-czterem-dobre-chrzciny'),
('ktorzy-mie-po-pjanemu-chcieli-w-preglu-topic'),
('alez-najslodszy-jezu-trzeba-pierwej-wiedziec'),
('z-kim-wojna-o-co-trzeba-to-swiatu-powiedziec-'),
('wolal-prusak-bo-jakze-lud-ruszy-za-nami'),
('gdzie-pojdzie-kiedy-gdzie-isc-my-nie-wiemy-sami'),
('bracia-szlachta-panowie-potrzeba-rozsadku'),
('dobrodzieje-potrzeba-ladu-i-porzadku'),
('chcecie-wojny-wiec-zrobmy-konfederacyja'),
('obmyslmy-gdzie-zawiazac-i-pod-laska-czyja'),
('tak-bylo-w-wielkopolszcze-widzim-rejterade'),
('niemiecka-coz-my-robim-wchodzim-tajnie-w-rade'),
('uzbrajamy-i-szlachte-i-wloscian-gromade'),
('gotowi-dabrowskiego-czekamy-rozkazu'),
('na-koniec-hejze-na-kon-powstajem-od-razu'),
('prosze-o-glos-zawolal-pan-komisarz-z-klecka'),
('czlowiek-mlody-przystojny-ubrany-z-niemiecka'),
('nie-wiedziec-pewnie-czyli-ze-szlachty-pochodzil'),
('lecz-o-to-nie-pytano-i-wszyscy-buchmana'),
('szacowali-iz-sluzyl-u-wielkiego-pana'),
('byl-dobry-patryjota-i-pelen-nauki'),
('z-ksiag-obcych-wyuczyl-sie-gospodarstwa-sztuki'),
('i-dobr-administracja-prowadzil-porzadnie'),
('o-polityce-takze-wnioskowal-rozsadnie'),
('pieknie-pisac-i-gladko-umial-sie-wyslawiac'),
('zatem-umilkli-wszyscy-kiedy-jal-rozprawiac'),
('prosze-o-glos-powtorzyl-po-dwakroc-odchrzaknal'),
('uklonil-sie-i-usty-dzwiecznymi-tak-brzaknal'),
('preopinanci-moi-w-swych-glosach-wymownych'),
('dyskusyja-na-wyzsze-wzniesli-stanowisko'),
('mnie-tylko-pozostaje-w-jedno-zjac-ognisko'),
('rzucone-trafne-mysli-i-rozumowania'),
('dwie-czesci-w-dyskusyji-calej-uwazalem'),
('podzial-juz-jest-zrobiony-ide-tym-podzialem'),
('naprzod-dlaczego-mamy-przedsiebrac-powstanie'),
('w-jakim-duchu-to-pierwsze-zywotne-pytanie'),
('drugie-rewolucyjnej-wladzy-sie-dotycze'),
('podzial-jest-trafny-tylko-przewrocic-go-zycze'),
('naprzod-zaczac-od-wladzy-skoro-pojmiem-wladze'),
('z-niej-powstania-istote-duch-cel-wyprowadze'),
('co-do-wladzy-wiec-kiedy-oczyma-przebiegam'),
('dzieje-calej-ludzkosci-i-coz-w-nich-spostrzegam'),
('oto-rod-ludzki-dziki-w-lasach-rozpierzchniony'),
('skupia-sie-zbiera-laczy-dla-wspolnej-obrony'),
('obmysla-ja-i-to-jest-najpierwsza-obrada'),
('potem-kazdy-wolnosci-wlasnej-czastke-sklada'),
('dla-dobra-powszechnego-to-pierwsza-ustawa'),
('z-ktorej-jako-ze-zrodla-plyna-wszystkie-prawa'),
('widzimy-tedy-ze-rzad-umowa-sie-tworzy'),
('nie-pochodzac-jak-mylnie-sadze-z-woli-bozej'),
('owoz-rzad-na-kontrakcie-oparlszy-spolecznym'),
('podzial-wladzy-juz-tylko-jest-skutkiem-koniecznym'),
('otoz-sa-i-kontrakty-kijowskie-czy-minskie-'),
('rzekl-stary-maciej-owoz-i-rzady-babinskie'),
('panie-buchman-czy-bog-nam-chcial-cara-narzucic'),
('czy-diabel-ja-z-waszmoscia-nie-bede-sie-klocic'),
('panie-buchman-gadaj-wasc-jakby-cara-zrzucic'),
('tu-sek-krzyknal-kropiciel-gdybym-mogl-podskoczyc'),
('do-tronu-i-kropidlem-plusk-raz-cara-zmoczyc'),
('to-juz-by-on-nie-wrocil-ni-kijowskim-traktem'),
('ni-minskim-ni-za-zadnym-buchmana-kontraktem'),
('aniby-go-wskrzesili-z-mocy-bozej-popi'),
('ni-z-mocy-belzebuba-ten-mi-zuch-kto-kropi'),
('panie-buchman-wascina-rzecz-bardzo-wymowna'),
('ale-wymowa-szum-drum-kropic-to-rzecz-glowna'),
('to-to-to-pisnal-rece-trac-bartek-brzytewka'),
('od-chrzciciela-do-macka-biegajac-jak-cewka'),
('od-jednej-strony-krosien-przerzucana-w-druga'),
('tylko-ty-macku-z-rozga-ty-macku-z-maczuga'),
('tylko-zgodzcie-sie-dalbog-pobijem-na-druzgi'),
('moskala-brzytew-idzie-pod-komende-rozgi'),
('komenda-przerwal-chrzciciel-dobra-ku-paradzie'),
('u-nas-byla-komenda-w-kowienskiej-brygadzie'),
('krotka-a-wezlowata-strasz-sam-sie-nie-strachaj'),
('bij-nie-daj-sie-postepuj-czesto-gesto-machaj'),
('szach-mach-to-pisnal-brzytwa-to-mi-regulament'),
('po-co-tu-pisac-akta-po-co-psuc-atrament'),
('konfederacji-trzeba-o-to-cala-sprzeczka'),
('jest-marszalek-nasz-maciej-a-laska-rozeczka'),
('niech-zyje-krzyknal-chrzciciel-kurek-na-kosciele'),
('szlachta-odpowiedziala-wiwant-kropiciele'),
('ale-w-katach-szmer-powstal-choc-w-srodku-tlumiony'),
('widac-ze-sie-rozdziela-rada-na-dwie-strony'),
('buchman-krzyknal-ja-zgody-nigdy-nie-pochwalam'),
('to-moj-system-ktos-drugi-wrzasnal-nie-pozwalam'),
('inni-z-katow-wtoruja-nareszcie-glos-gruby'),
('ozwal-sie-przybylego-szlachcica-skoluby'),
('coz-to-panstwo-dobrzynscy-a-to-co-sie-swieci'),
('a-my-czy-to-bedziemy-z-pod-prawa-wyjeci'),
('kiedy-nas-zapraszano-z-naszego-zascianku'),
('a-zapraszal-nas-klucznik-rebajlo-mopanku'),
('mowiono-nam-ze-wielkie-rzeczy-dziac-sie-mialy'),
('ze-tu-nie-o-dobrzynskich-lecz-o-powiat-caly'),
('o-cala-szlachte-idzie-toz-i-robak-bakal'),
('choc-nigdy-nie-dokonczyl-i-zawsze-sie-jakal'),
('i-ciemno-sie-tlumaczyl-wreszcie-koniec-koncow'),
('my-zjechali-sasiadow-zwolali-przez-goncow'),
('nie-sami-tu-panowie-dobrzynscy-jestescie'),
('wszyscy-wiec-radzmy-jesli-potrzeba-marszalka'),
('glosujmy-wszyscy-rowna-u-kazdego-galka'),
('i-czterej-stypulkowscy-i-trzej-mickiewicze'),
('krzykneli-wiwat-rownosc-stajac-za-skoluba'),
('tymczasem-buchman-wolal-zgoda-bedzie-zguba'),
('kropiciel-krzyczal-bez-was-obejdziem-sie-sami'),
('niech-zyje-nasz-marszalek-maciek-nad-mackami'),
('hej-do-laski-dobrzynscy-krzycza-zapraszamy'),
('a-obca-szlachta-wola-w-glos-nie-pozwalamy'),
('rozstrycha-sie-tlum-na-dwie-kupy-rozdzielony'),
('i-kiwajac-glowami-w-dwie-przeciwne-strony'),
('tamci-nie-pozwalamy-ci-krzycza-prosiemy'),
('maciek-stary-w-posrodku-jeden-siedzial-niemy'),
('i-jedna-glowa-jego-byla-nieruchoma'),
...
('ksiadz-robak-o-tym-gadal-wszakze-wszyscy-wiecie'),
...
('nieprawdaz-prawda-rzekli-jakby-z-ksiazki-czyta'),
...
('prosze-milczec-sluchamy-sprawa-na-tym-zyska'),
...
('ktoz-to-mamze-wam-gadac-a-juz-ci-soplica-'),
...
('hejze-krzykneli-wszyscy-hejze-na-soplice'),
('lecz-prusak-smial-podjac-sie-sedziego-obrony'),
('i-wolal-z-wzniesionymi-ku-szlachcie-ramiony'),
('panowie-bracia-aj-aj-a-na-boskie-rany'),
('co-znowu-panie-klucznik-czy-wasc-opetany'),
('czy-o-tym-byla-mowa-ze-ktos-mial-wariata'),
('banite-bratem-to-co-karac-go-za-brata'),
...
('nie-tak-panowie-bracia-w-wielkopolszcze-bylo'),
...
('trafiala-do-serc-powstal-krzyk-oklask-wesela'),
...
('splawial-do-prus-dwadziescia-horeszkowskich-wicin'),
('stad-sie-zbogacil-i-on-i-jego-rodzina'),
...
('czekajno-niech-no-ja-mu-z-konewki-naleje'),
...
('urosla-w-litwie-wszakze-to-dobrzynscy-sami'),
('bili-sie-na-zajezdzie-myskim-z-moskalami'),
('ktorych-przywiodl-jeneral-ruski-wojnilowicz'),
('i-lotr-przyjaciel-jego-pan-wolk-z-logomowicz'),
...
('po-coz-o-tym-wspominac-dzis-darmo-pan-hrabia'),
...
('-tu-wydobyl-z-kieszeni-garsc-kul-dzwonil-nimi-'),
('ot-galki-krzyknal-w-sedzie-galkami-wszystkimi'),
...
('wiwat-klucznik-rebajlo-hejze-na-soplice'),
...
('nieruchomy-wstal-z-lawy-i-wolnymi-kroki'),
...
('o-dobru-pospolitym-glupi-u-was-zwada'),
...
('precz-stad-bo-jakom-maciek-was-do-milijonow'),
...
('szepnely-wiotkim-skrzydlem-nietoperze-leca'),
('pod-dom-gdzie-szyby-okien-twarze-ludzi-swieca'),
('blizej-zas-nietoperzow-siostrzyczki-cmy-rojem'),
...
('drugi-staw-z-dnem-blotnistym-i-gardzielem-metnym'),
...
('jeden-zowie-sie-*litwa*-a-drugi-*korona*'),
('dalej-niebieskiej-*wagi*-dwie-szale-blyskaja'),
...
('mlecznym-goscincem-pedzac-cwal-w-niebieskie-progi'),
('az-go-michal-zbil-z-wozu-a-woz-zrzucil-z-drogi'),
...
('ze-ow-zodyjakowy-*smok*-dlugi-i-gruby'),
('ktory-gwiazdziste-wije-po-niebie-przeguby'),
('ktorego-mylnie-wezem-chrzcza-astronomowie'),
...
('widzieli-jak-przez-cmentarz-szla-dziewica-moru'),
('ktora-wznosi-sie-czolem-nad-najwyzsze-drzewa'),
('a-w-lewym-reku-chustka-skrwawiona-powiewa'),
('rozne-stad-wnioski-tworzyl-stojacy-przy-plocie'),
('ciwun-co-przyszedl-zdawac-sprawe-o-robocie'),
('i-pisarz-prowentowy-w-szeptach-z-ekonomem'),
('lecz-podkomorzy-siedzial-na-przyzbie-przed-domem'),
('przerwal-rozmowe-gosci-znac-ze-glos-zabiera'),
('blysnela-przy-ksiezycu-wielka-tabakiera'),
('(cala-z-szczerego-zlota-z-brylantow-oprawa'),
('we-srodku-za-szklem-portret-krola-stanislawa)'),
('zadzwonil-w-nia-palcami-zazyl-i-rzekl-panie'),
('tadeuszu-wascine-o-gwiazdach-gadanie'),
('jest-tylko-echem-tego-co-slyszales-w-szkole'),
('ja-o-cudzie-prostakow-poradzic-sie-wole'),
('i-ja-astronomii-sluchalem-dwa-lata'),
('w-wilnie-gdzie-puzynina-madra-i-bogata'),
('pani-oddala-dochod-z-wioski-dwiestu-chlopow'),
('na-zakupienie-roznych-szkiel-i-teleskopow'),
('ksiadz-poczobut-czlek-slawny-byl-obserwatorem'),
('i-calej-akademii-naonczas-rektorem'),
('przeciez-w-koncu-katedre-i-teleskop-rzucil'),
('do-klasztoru-do-cichej-celi-swej-powrocil'),
('i-tam-umarl-przykladnie-znam-sie-tez-z-sniadeckim'),
('owoz-astronomowie-planete-komete'),
('uwazaja-tak-jako-mieszczanie-karete'),
('wiedza-czyli-zajezdza-przed-krola-stolice'),
('czyli-z-rogatek-miejskich-rusza-za-granice'),
('czy-krol-posla-z-pokojem-czy-z-wojna-wyprawial'),
('o-to-ani-pytaja-pomne-za-mych-czasow'),
('gdy-branecki-kareta-swa-ruszyl-do-jassow'),
('i-za-ta-niepoczciwa-pociagnal-kareta'),
('ogon-targowiczanow-jak-za-ta-kometa'),
('lud-prosty-choc-w-publiczne-nie-mieszal-sie-rady'),
('zgadnal-zaraz-ze-ogon-ow-jest-wrozba-zdrady'),
('slychac-ze-lud-dal-imie-miotly-tej-komecie'),
('i-powiada-ze-ona-milijon-wymiecie'),
('a-na-to-rzekl-z-uklonem-wojski-prawda-jasnie'),
('wielmozny-podkomorzy-przypominam-wlasnie'),
('co-mnie-mowiono-niegdys-malemu-dziecieciu'),
('pamietam-choc-nie-mialem-wowczas-lat-dziesieciu'),
('kiedy-widzialem-w-domu-naszym-nieboszczyka'),
('sapiehe-pancernego-znaku-porucznika'),
('co-potem-byl-nadwornym-marszalkiem-krolewskim'),
('na-koniec-umarl-wielkim-kanclerzem-litewskim'),
('miawszy-lat-sto-i-dziesiec-ten-za-krola-jana'),
('trzeciego-byl-pod-wiedniem-w-choragwi-hetmana'),
('jablonowskiego-owoz-ow-kanclerz-powiadal'),
('ze-wlasnie-kiedy-na-kon-krol-jan-trzeci-siadal'),
('gdy-nuncyjusz-papieski-zegnal-go-na-droge'),
('a-posel-austryjacki-calowal-mu-noge'),
('podajac-strzemie-(posel-zwal-sie-wilczek-hrabia)'),
('krol-krzyknal-patrzcie-co-sie-na-niebie-wyrabia'),
('spojrza-alic-nad-glowy-suwal-sie-kometa'),
('droga-jaka-ciagnely-wojska-mahometa'),
('z-wschodu-na-zachod-potem-i-ksiadz-bartochowski'),
('skladajac-panegiryk-na-tryumf-krakowski'),
('pod-godlem-orientis-fulmen-prawil-wiele'),
('o-tym-komecie-takze-czytam-o-nim-w-dziele'),
('pod-tytulem-janina-gdzie-jest-opisana'),
('cala-wyprawa-krola-nieboszczyka-jana'),
('i-wyryta-choragiew-wielka-mahometa'),
('i-ow-taki-jak-dzis-go-widzimy-kometa'),
('amen-rzekl-na-to-sedzia-ja-wrozbe-waszeci'),
('przyjmuje-oby-z-gwiazda-zjawil-sie-jan-trzeci'),
('jest-na-zachodzie-wielki-dzis-bohater-moze'),
('kometa-go-przywiedzie-do-nas-co-daj-boze'),
('na-to-rzekl-wojski-glowe-pochyliwszy-smutnie'),
('kometa-czasem-wojny-czasem-wrozy-klotnie'),
('niedobrze-iz-sie-zjawil-tuz-nad-soplicowem'),
('moze-nam-grozi-jakiem-nieszczesciem-domowem'),
('mielismy-wczoraj-dosyc-rozterku-i-zwady'),
('tak-w-czasie-polowania-jako-i-biesiady'),
('rejent-klocil-sie-z-rana-z-panem-asesorem'),
('a-pan-tadeusz-wyzwal-hrabiego-wieczorem'),
('pono-spor-ten-ze-skory-niedzwiedziej-pochodzil'),
('i-gdyby-mnie-dobrodziej-sedzia-nie-przeszkodzil'),
('ja-bym-u-stolu-obu-przeciwnikow-zgodzil'),
('bo-chcialem-opowiedziec-wypadek-ciekawy'),
('podobny-do-zdarzenia-wczorajszej-wyprawy'),
('poslowi-rejtanowi-i-ksieciu-denassow'),
('czy-tez-gdy-dobrze-pomne-na-sejm-do-warszawy'),
('po-drodze-zwiedzal-szlachte-juz-to-dla-zabawy'),
('juz-dla-popularnosci-wstapil-wiec-do-pana'),
('tadeusza-dzis-swietej-pamieci-rejtana'),
('ktory-byl-potem-naszym-nowogrodzkim-poslem'),
('i-w-ktorego-ja-domu-od-dziecinstwa-wzroslem'),
('owoz-rejtan-na-przyjazd-ksiecia-jenerala'),
('zaprosil-gosci-liczna-szlachta-sie-zebrala'),
('bylo-teatrum-(ksiaze-kochal-sie-w-teatrze)'),
('fajerwerk-dawal-kaszyc-ktory-mieszka-w-jatrze'),
('pan-tyzenhauz-tancerzy-przyslal-a-kapele'),
('oginski-i-pan-soltan-co-mieszka-w-zdzienciele'),
('slowem-dawano-huczne-nad-podziw-zabawy'),
('w-domu-a-w-lasach-wielkie-robiono-oblawy'),
('wiadomo-zas-waszmosciom-jest-ze-prawie-wszyscy'),
('ile-ich-zapamietac-mozna-czartoryscy'),
('choc-ida-z-jagiellonow-krwi-lecz-do-myslistwa'),
('nie-sa-bardzo-pochopni-pewno-nie-z-lenistwa'),
('lecz-z-gustow-cudzoziemskich-i-ksiaze-jeneral'),
('czesciej-do-ksiazek-nizli-do-psiarni-zazieral'),
('i-do-alkowek-damskich-czesciej-niz-do-lasow'),
('w-swicie-ksiecia-byl-ksiaze-niemiecki-denassow-'),
('o-ktorym-powiadano-ze-w-libijskiej-ziemi'),
('goszczac-polowal-niegdys-z-krolmi-murzynskiemi'),
('i-tam-tygrysa-spisa-w-recznym-boju-zwalil'),
('z-czego-sie-bardzo-ksiaze-ow-denassow-chwalil'),
('u-nas-zas-polowano-na-dziki-w-te-pore'),
('rejtan-zabil-ze-sztucca-ogromna-maciore'),
('z-wielkim-niebezpieczenstwem-bo-z-bliska-wypalil'),
('kazdy-z-nas-trafnosc-strzalu-wydziwial-i-chwalil'),
('tylko-niemiec-denassow-obojetnie-sluchal'),
('pochwal-takich-i-chodzac-pod-nos-sobie-dmuchal'),
('ze-trafny-strzal-dowodzi-tylko-smiale-oko'),
('biala-bron-smiala-reke-i-zaczal-szeroko'),
('znowu-gadac-o-swojej-libiji-i-spisie'),
('o-swych-krolach-murzynskich-i-o-swym-tygrysie'),
('markotno-to-sie-stalo-panu-rejtanowi'),
('byl-czlek-zywy-uderzyl-po-szabli-i-mowi'),
('mosci-ksiaze-kto-patrzy-smiele-walczy-smiele'),
('warte-dziki-tygrysow-a-spis-karabele'),
('i-zaczynali-z-niemcem-dyskurs-nazbyt-zwawy'),
('szczesciem-ksiaze-jeneral-przerwal-te-rozprawy'),
('godzac-ich-po-francusku-co-tam-gadal-nie-wiem'),
('ale-ta-zgoda-byl-to-popiol-nad-zarzewiem'),
('bo-rejtan-wzial-do-serca-okazyi-czekal'),
('i-dobra-sztuke-splatac-niemcowi-przyrzekal'),
('tej-sztuki-ledwie-wlasnym-nie-przyplacil-zdrowiem'),
('a-splatal-ja-nazajutrz-jak-to-wnet-opowiem'),
('tu-wojski-umilknawszy-prawa-reke-wznosil'),
('i-u-podkomorzego-tabakiery-prosil'),
('dlugo-zazywa-konczyc-powiesci-nie-raczy'),
('jak-gdyby-chcial-zaostrzyc-ciekawosc-sluchaczy'),
('zaczynal-wreszcie-kiedy-znowu-mu-przerwano'),
('powiesc-taka-ciekawa-tak-pilnie-sluchana'),
('bo-do-sedziego-nagle-ktos-przyslal-czlowieka'),
('donoszac-ze-z-niezwlocznym-interesem-czeka'),
('sedzia-dajac-dobranoc-zegnal-cale-grono'),
('ci-spac-do-domu-tamci-w-stodole-na-sianie'),
('sedzia-szedl-podroznemu-dawac-posluchanie'),
('inni-juz-spia-tadeusz-po-sieniach-sie-zwija'),
('chodzac-jako-wartownik-okolo-drzwi-stryja'),
('bo-musi-w-waznych-rzeczach-rady-jego-szukac'),
...
('wreszcie-po-cwiercgodzinnym-przerwaniu-rozmowy'),
...
('juz-w-ucho-szepnal-o-tym-mnie-moj-palec-maly'),
...
('uwazalem-ze-waszec-wczoraj-gryzles-wargi'),
...
('to-znowu-bog-wie-o-co-do-zebow-sie-kloca'),
...
('teraz-nie-moglbym-z-panna-roza-sie-ozenic'),
...
('sam-wasci-zosie-he-coz-nie-skoczysz-z-radosci'),
...
('daj-mi-stryjaszku-tylko-twe-blogoslawienstwo'),
...
('i-ten-wyjazd-oj-jest-tu-w-tym-jakas-zawilosc'),
...
('to-sie-wasci-nie-uda-lubisz-czy-nie-lubisz'),
...
('dzis-dosc-mialem-klopotow-az-mnie-glowa-boli'),
...
('co-poczac-jesli-zosia-o-wszystkim-sie-dowie'),
('prosic-o-reke-a-coz-telimena-powie'),
...
('w-wojsku-polskim-teraz-stryj-ten-rozkaz-powtorzyl'),
...
('ze-twoja-sklonnosc-byla-prawdziwym-kochaniem'),
...
('pomnac-jakos-mnie-kochal-i-zaczela-szlochac'),
...
('jesli-nie-prawda-zem-cie-dalbog-bardzo-lubil'),
...
('i-dalibog-ze-nigdy-ciebie-nie-zapomne'),
...
('jechac-za-mna-ja-bedac-sam-prostym-zolnierzem'),
...
('zes-mnie-uwiodl-i-teraz-porzucil-sierote'),
...
('a-juzes-pod-jej-okiem-nowych-ofiar-szukal'),
('uciekaj-lecz-cie-moje-dosiegna-przeklenstwa-'),
...
('wiec-kulak-przycisnawszy-na-schylonym-czole'),
...
('i-harmonia-cudna-orkiestry-podwodnej'),
...
('jako-piekny-waz-zmudzki-zwany-giwojtosem'),
...
('przebog-czy-sie-to-zgadza-z-pana-urodzeniem'),
...
('i-hejze-na-soplice-tysiac-glosow-wrzaslo'),
...
('soplicowie-jestescie-moimi-wiezniami'),
('tak-zrobilem-we-wloszech-kiedy-pod-opoka'),
('ktora-sycylianie-zwa-birbante-rokka'),
...
('bylo-to-osobliwsze-szczescie-dla-soplicow'),
...
('przemyslal-jakby-skonczyc-boj-bez-krwi-rozlewu'),
('wiec-rodzine-soplicow-w-domu-zamknac-kaze'),
('jako-wiezniow-wojennych-u-drzwi-stawi-straze'),
('wtem-hejze-na-soplicow-wpada-szlachta-hurmem'),
...
('do-domu-niewpuszczeni-biega-do-folwarkow'),
...
('belek-(pod-plotem-sadu-suszyly-sie-belki)'),
...
('co-niegdys-ocalilo-rzym-przed-galow-zdrada'),
...
('unoszony-jak-kolmi-gestych-skrzydel-ruchem'),
...
('ptastwo-piekne-karmione-perlowymi-krupy'),
...
('ten-z-misa-ten-nad-kotlem-ten-przy-wolu-cwierci'),
...
('nazwane-*kosarzami*-na-muchy-wpolsenne'),
...
('oba-drewna-gwozdziami-przebite-po-rogach'),
...
('a-czy-sedzia-rzekl-major-zolta-ksiege-czytal'),
...
('wiec-pan-sedzia-powinnosc-znajac-gospodarza'),
('jechal-kapturem-na-wpol-zasloniwszy-lice'),
('ale-go-wnet-poznano-bo-gdy-wiezniow-minal'),
('zwrocil-sie-ku-nim-twarza-palcem-na-znak-skinal'),
('i-drugiej-bryki-furman-rownie-byl-poznany'),
('stary-maciek-rozeczka-za-chlopa-przebrany'),
('szlachta-zaczela-krzyczec-skoro-sie-pokazal'),
...
('zaczeli-z-dawnych-gniewow-ostygac-powoli'),
('bo-szlachta-polska-chociaz-niezmiernie-klotliwa'),
('i-porywcza-do-bitew-przeciez-nie-jest-msciwa'),
('biega-wiec-do-macieja-starego-po-rade'),
('on-kolo-wozow-cala-ustawia-gromade'),
('zaledwie-go-poznano-choc-nie-zmienil-stroju'),
('tak-przybral-inna-postac-zwyczajnie-ponury'),
('zamyslony-a-teraz-glowe-wzniosl-do-gory'),
('i-z-mina-rozjasniona-jak-kwestarz-rubacha'),
('nim-zaczal-gadac-dlugo-smial-sie'),
('klaniam-klaniam-cha-cha-cha-wysmienicie-przednie'),
('panowie-oficery-kto-poluje-we-dnie'),
('wy-w-nocy-dobry-polow-widzialem-zwierzyne'),
('oj-skubac-skubac-szlachte-oj-drzec-z-nich-lupine'),
('oj-wezciez-ich-na-munsztuk-bo-tez-szlachta-bryka'),
('winszuje-ci-majorze-zes-zlowil-hrabika'),
('to-tluscioszek-to-bogacz-panicz-z-antenatow'),
('nie-wypuszczaj-go-z-klatki-bez-trzysta-dukatow'),
('a-jak-wezmiesz-na-klasztor-daj-jakie-trzy-grosze'),
('i-dla-mnie-bo-ja-zawzdy-za-twa-dusze-prosze'),
('jakem-bernardyn-bardzo-mysle-o-twej-duszy'),
('smierc-i-sztabsoficerow-porywa-za-uszy'),
('dobrze-napisal-baka-ze-smierc-dzga-za-katy'),
('w-szkarlaty-i-po-suknie-nieraz-dobrze-stuknie'),
('i-po-plotnie-tak-utnie-jak-i-po-kapturze'),
('i-po-fryzurze-rownie-jak-i-po-mundurze'),
('smierc-matula-powiada-baka-jak-cebula'),
('lzy-wyciska-gdy-sciska-a-rownie-przytula'),
('i-dziecko-co-sie-lula-i-zucha-co-hula'),
('ach-ach-majorze-dzisiaj-zyjem-jutro-gnijem'),
('to-tylko-nasze-co-dzis-zjemy-i-wypijem'),
('panie-sedzio-wszakze-to-czas-podobno-sniadac'),
('siadam-za-stol-i-prosze-wszystkich-za-mna-siadac'),
('majorze-gdyby-zrazow-panie-poruczniku'),
('co-myslisz-gdyby-waze-dobrego-ponczyku'),
('to-prawda-ojcze-rzekli-dwaj-oficerowie-'),
('czas-by-juz-zjesc-i-wypic-pana-sedzi-zdrowie'),
('zdziwili-sie-domowi-patrzac-na-robaka'),
('skad-mu-sie-wziela-mina-i-wesolosc-taka'),
('sedzia-wnet-kucharzowi-powtorzyl-rozkazy'),
('wniesiono-waze-cukier-butelki-i-zrazy'),
('plut-i-rykow-tak-czynnie-zaczeli-sie-zwijac'),
('tak-lakomie-polykac-i-gesto-zapijac'),
('ze-w-pol-godziny-zjedli-dwadziescia-trzy-zrazy'),
('i-wychylili-ponczu-ogromne-pol-wazy'),
('wiec-major-syt-i-wesol-w-krzesle-sie-rozwalil'),
('dobyl-fajke-biletem-bankowym-zapalil'),
('i-otarlszy-sniadanie-z-ust-koncem-serwety'),
('obrocil-smiejace-sie-oczy-na-kobiety'),
...
('albo-pojdzmy-mazurka-he-do-diablow-trzysta'),
...
('tanczyc-zawolal-robak-gdy-wychyle-flasze'),
('to-i-ja-choc-ksiadz-habit-czasami-podkasze'),
('i-potancze-mazurka-ale-wiesz-majorze'),
('my-tu-pijem-a-jegry-tam-zmarzna-na-dworze'),
('hulac-to-hulac-sedzio-daj-beczke-siwuchy'),
...
('rykow-kapitan-milczkiem-kielichy-wychylal'),
('lecz-major-pil-i-razem-damom-sie-przymilal'),
('a-wzmagal-sie-w-nim-coraz-tancowania-zapal'),
('rzucil-fajke-i-reke-telimeny-zlapal'),
('chcial-tanczyc-lecz-uciekla-wiec-podszedl-do-zosi'),
('klaniajac-sie-slaniajac-do-mazurka-prosi'),
('hej-ty-rykow-przestanze-tam-trabic-na-fajce'),
('precz-fajka-wszak-ty-dobrze-grasz-na-balabajce'),
('widzisz-no-tam-gitare-podz-no-wez-gitare'),
('i-mazurka-ja-major-ide-w-pierwsza-pare'),
('kapitan-wzial-gitare-i-struny-przykrecal'),
('plut-znowu-telimene-do-tanca-zachecal'),
('slowo-majorskie-panno-nie-rosyjaninem'),
('jestem-jezeli-klamie-chce-byc-sukinsynem'),
('jezeli-klamie-spytaj-a-oficerowie'),
('wszyscy-poswiadcza-cala-armija-to-powie'),
('ze-w-tej-drugiej-armiji-w-korpusie-dziewiatym'),
('w-drugiej-pieszej-dywizji-w-pulku-piecdziesiatym'),
('jegerskim-major-plut-jest-pierwszy-mazurzysta'),
('podzze-panienko-nie-badz-taka-narowista'),
...
('biegl-przebic-wtem-ksiadz-dostal-z-rekawa-krocice'),
('pal-tadeuszku-krzyknal-pal-jak-w-jasna-swiece'),
('tadeusz-wnet-pochwycil-wymierzyl-wypalil'),
('chybil-ale-majora-zgluszyl-i-osmalil'),
('porywa-sie-z-gitara-rykow-bunt-bunt-wola'),
('wpada-na-tadeusza-lecz-wojski-zza-stola'),
('machnal-reka-na-odlew-noz-w-powietrzu-swisnal'),
('miedzy-glowy-i-pierwej-uderzyl-niz-blysnal'),
('uderza-w-dno-gitary-na-wylot-ja-wierci'),
('schylil-sie-na-bok-rykow-i-tak-uszedl-smierci'),
...
('przez-okna-z-rapierami-rozeczka-na-czele'),
('plut-w-sieni-rykow-za-nim-wolaja-zolnierzy'),
...
('maciek-stal-u-drzwi-z-rozga-wzniesiona-do-gory'),
...
('zdarl-je-rozga-spadajac-brzekla-po-bagnetach'),
('moskale-cofaja-sie-maciek-ich-wygania'),
('tam-stronnicy-soplicow-pracuja-w-zawody'),
('nad-rozkuciem-dobrzynskich-rozrywaja-klody'),
('widzac-to-jegry-za-bron-porywaja-biega'),
...
('i-z-gory-tak-uderzyl-w-grzbiet-rosyjanina'),
('ze-twarz-jego-i-skron-wbil-w-zamek-karabina'),
('sierzant-u-nog-chrzciciela-na-swa-bron-sie-zwalil'),
...
('chrzciciel-nie-zdola-dobiec-lecz-staje-wpol-drogi'),
...
('a-zajac-targnawszy-sie-orla-wpol-rozsczepi'),
...
('uzbrojone-w-krzemienie-i-guzy-i-seki'),
...
('zebrawszy-kolo-siebie-pol-batalijonu'),
...
('caly-szereg-zdaje-sie-byc-ruchomym-plazem'),
...
('za-goscinnymi-stoly-sedziego-zasiada'),
...
('gdzie-stal-sztab-za-czym-rykow-gniewa-sie-i-dasa'),
...
('anizeli-rozrzucac-albo-tez-przestawiac'),
...
('z-poludnia-juz-ich-stado-pol-niebios-obieglo'),
...
('stoja-na-ksztalt-posagow-sypilskiej-nijoby'),
('jedna-osina-drzaca-wstrzasa-liscie-siwe'),
...
('swieci-ziemia-ponuro-zoltawo-czerwona'),
...
('az-je-przerwal-kapitan-rykow-tymi-slowy'),
...
('zes-czlek-poczciwy-wiedza-tu-wszyscy-ziemianie'),
...
('coz-czy-plut-bedzie-milczec-czy-slowem-zareczyl'),
...
('juz-ci-zakonczyl-sedzia-byl-w-tym-palec-bozy'),
...
('ale-musze-wac-panstwu-wyznac-bez-ogrodki'),
...
('to-o-czymem-z-pewnoscia-wczoraj-sie-dowiedzial'),
...
('toc-by-ich-panie-bracie-przynajmniej-zareczyc'),
...
('i-z-tymi-swietosciami-do-pokoju-wchodzi'),
...
('nie-bedziem-sie-zbojczymi-rozpierac-zelazy'),
('niech-sie-inaczej-spor-nasz-zalotny-roztrzygnie'),
...
('kochac-i-byc-szczesliwym-mych-przeznaczen-wladza-'),
...
('i-gdy-niesmiertelnymi-przeslonisz-wawrzyny'),
...
('i-usiada-na-lozko-przy-nim-a-gerwazy'),
...
('a-jacek-mowil-coraz-wolniejszymi-slowy'),
...
('jedno-slowo-stolnika-jakze-bysmy-byli'),
...
('sline-w-gebie-a-dlonie-rekojesc-sciskalem'),
...
('odwagi-zagniewac-jej-zatrwozyc-milczalem'),
('i-ja-zawadyjaka-slawny-w-litwie-calej'),
('co-przede-mna-najwieksze-pany-niegdys-drzaly'),
('com-nie-zyl-dnia-bez-bitki-co-nie-stolnikowi'),
('ale-bym-sie-pokrzywdzic-nie-dal-i-krolowi'),
...
('wszczal-dyskurs-o-czym-o-czym-o-corki-weselu'),
('w-tej-chwili-o-gerwazy-uwaz-przyjacielu'),
('wlasnie-przyjechal-do-mnie-swat-kasztelanica'),
('ty-jestes-moj-przyjaciel-coz-ty-mowisz-na-to'),
('wiesz-wasze-ze-mam-corke-piekna-i-bogata'),
('a-kasztelan-witebski-wszakze-to-w-senacie'),
('niskie-drazkowe-krzeslo-coz-mi-radzisz-bracie'),
...
('wynajdujesz-coz-one-nie-zmniejsza-twej-winy'),
('bo-wszakze-zdarzalo-sie-juz-nieraz-na-swiecie'),
('ze-kto-pokochal-panskie-lub-krolewskie-dziecie'),
('staral-sie-gwaltem-zdobyc-przemyslal-wykradac'),
('mscil-sie-otwarcie-ale-tak-chytrze-smierc-zadac'),
...
('lecz-ona-biedna-tak-ja-rodzice-piescili'),
('slaba-lekliwa-byl-to-robaczek-motyli'),
('wiosenna-gasiennica-i-tak-ja-zagrabic'),
('dotknac-ja-zbrojna-reka-byloby-ja-zabic'),
('mscic-sie-otwarcie-szturmem-zamek-zwalic-w-gruzy'),
('wstyd-bo-by-powiedziano-zem-mscil-sie-rekuzy'),
('kluczniku-twoje-serce-poczciwe-nie-umie'),
('uczuc-ile-jest-piekla-w-obrazonej-dumie'),
('szatan-dumy-zaczal-mi-lepsze-plany-raic'),
('zemscic-sie-krwawo-ale-powod-zemsty-taic'),
('nie-bywac-w-zamku-milosc-z-serca-wykorzenic'),
('puscic-w-niepamiec-ewe-z-inna-sie-ozenic'),
('a-potem-potem-jaka-wynalezc-zaczepke'),
('i-zdalo-mi-sie-zrazu-zem-juz-serce-zmienil'),
('i-rad-bylem-z-wymyslu-i-jam-sie-ozenil'),
('z-pierwsza-ktoram-napotkal-dziewczyna-uboga'),
('zlem-zrobil-jakze-bylem-ukarany-srogo'),
('nie-kochalem-jej-biedna-matka-tadeusza'),
('najprzywiazansza-do-mnie-najpoczciwsza-dusza-'),
('ale-jam-dawna-milosc-i-zlosc-w-sercu-dusil'),
('bylem-jako-szalony-darmom-siebie-musil'),
('zajac-sie-gospodarstwem-albo-interesem'),
('wszystko-na-prozno-zemsty-opetany-biesem'),
('zly-opryskliwy-znalezc-nie-moglem-pociechy'),
...
('pilem-nie-moglem-zapic-pamieci-na-chwile'),
('ani-pozbyc-sie-chociaz-przebieglem-ziem-tyle'),
('teraz-oto-w-habicie-jestem-bozym-sluga'),
('na-lozu-we-krwi-o-niej-mowilem-tak-dlugo-'),
('w-tej-chwili-o-tych-rzeczach-mowic-bog-wybaczy'),
('musicie-wiedziec-w-jakim-zalu-i-rozpaczy'),
('bylo-to-wlasnie-wkrotce-po-jej-zareczynach'),
...
('zgadywano-ze-kogos-potajemnie-kocha-'),
...
('mnie-com-niegdys-rzec-moge-trzasl-calym-powiatem'),
('mnie-ktorego-radziwill-nazywal-kochanku'),
('mnie-com-kiedy-wyjezdzal-z-mojego-zascianku'),
('to-liczniejszy-dwor-mialem-nizeli-ksiazecy'),
('kiedym-szable-dostawal-to-kilka-tysiecy'),
('szabel-blyszczalo-wkolo-straszac-zamki-panskie'),
('a-potem-ze-mnie-smialy-sie-dzieci-wloscianskie'),
...
('prawda-prawda-wiec-to-ty-i-tyzes-to-jacku'),
('soplico-pod-kapturem-zyles-po-zebracku'),
('ty-ktorego-pamietam-gdy-zdrowy-rumiany'),
('piekny-szlachcic-gdy-tobie-pochlebialy-pany'),
('gdy-za-toba-kobiety-szalaly-wasalu'),
('nie-tak-dawno-takes-zestarzal-sie-z-zalu'),
('jakzem-ciebie-nie-poznal-po-owym-wystrzale'),
('kiedys-tak-do-niedzwiedzia-trafil-doskonale'),
('bo-nad-ciebie-nie-miala-strzelca-litwa-nasza'),
('byles-takze-po-macku-pierwszy-do-palasza'),
('prawda-o-tobie-niegdys-spiewaly-szlachcianki'),
('*oto-jacek-was-kreci-trzesa-sie-zascianki*'),
('*a-komu-na-swym-wasie-wezelek-zawiaze*'),
('*ten-zadrzy-chocby-to-byl-sam-radziwill-ksiaze*'),
('zawiazales-ty-wezel-i-mojemu-panu'),
('nieszczesniku-i-tyzes-do-takiego-stanu'),
('jacek-wasal-kwestarzem-wielkie-sady-boze'),
('i-teraz-ha-bezkarnie-ujsc-tobie-nie-moze'),
('przysiegam-kto-horeszkow-krwi-krople-wysaczyl'),
('tymczasem-ksiadz-na-lozu-usiadl-i-tak-konczyl'),
('jezdzilem-kolo-zamku-ile-biesow-w-glowie'),
...
('pomysl-o-zemscie-to-wnet-szatan-bron-podsunie'),
('ledwiem-pomyslil-szatan-nasyla-moskali'),
('stalem-patrzac-wiesz-jak-wasz-zamek-szturmowali'),
('bo-falsz-zebym-byl-w-jakiej-z-moskalami-zmowie'),
('patrzylem-rozne-mysli-snuly-sie-po-glowie'),
('zrazu-z-usmiechem-glupim-jak-na-pozar-dziecko'),
('patrzylem-potem-radosc-uczulem-zbojecka'),
('czekajac-rychlo-zacznie-palic-sie-i-walic'),
('czasem-mysl-przychodzila-skoczyc-ja-ocalic'),
('broniliscie-sie-ty-wiesz-dzielnie-i-przytomnie'),
('zdziwilem-sie-moskale-padali-wkolo-mnie'),
('bydleta-zle-strzelaja-na-widok-ich-kleski'),
('zlosc-mie-znowu-porwala-ten-stolnik-zwycieski'),
('i-takze-mu-na-swiecie-wszystko-sie-powodzi'),
('i-z-tej-strasznej-napasci-z-tryumfem-wychodzi'),
('odjezdzalem-ze-wstydem-wlasnie-byl-poranek'),
('wtem-ujrzalem-poznalem-wystapil-na-ganek'),
('i-brylantowa-szpinka-ku-sloncu-migotal'),
('i-was-pokrecal-dumnie-i-wzrok-dumny-miotal'),
('i-zdalo-mi-sie-ze-mnie-szczegolniej-uragal'),
...
('moze-rozbroic-wroga-miecz-wpol-drogi-wstrzymac'),
('ale-ta-bron-ognista-dosyc-zamek-imac'),
('czyz-uciekalem-kiedys-mierzyl-do-mnie-z-gory'),
('utkwilem-oczy-we-dwie-twojej-broni-rury'),
('rozpacz-jakas-zal-dziwny-do-ziemi-mnie-przybil'),
('czemuz-ach-moj-gerwazy-czemus-wtenczas-chybil'),
('laske-bys-zrobil-widac-za-pokute-grzechu'),
('ilez-ty-krwi-wylales-twoim-jednym-strzalem'),
('ilez-klesk-spadlo-na-nas-i-na-twa-rodzine'),
('a-wszystko-to-przez-wasza-panie-jacku-wine'),
('a-wszakze-gdy-dzis-jegry-hrabie-na-cel-wzieli'),
('ostatniego-z-horeszkow-chociaz-po-kadzieli'),
('tys-go-zaslonil-i-gdy-moskal-do-mnie-palil'),
('tys-mnie-rzucil-o-ziemie-tak-nas-dwoch-ocalil'),
('jesli-prawda-ze-jestes-ksiedzem-zakonnikiem'),
('juzci-sukienka-broni-cie-przed-scyzorykiem'),
('badz-zdrow-wiecej-na-waszym-nie-postane-progu'),
('z-nami-kwita-zostawmy-reszte-panu-bogu'),
('jacek-reke-wyciagnal-cofnal-sie-gerwazy'),
('nie-moge-rzekl-bez-mego-szlachectwa-obrazy'),
('dotykac-reke-takim-morderstwem-skrwawiona'),
('z-prywatnej-zemsty-nie-zas-pro-publico-bono'),
('ale-jacek-z-poduszek-na-loze-upadlszy'),
('zwrocil-sie-ku-sedziemu-a-byl-coraz-bladszy'),
('i-niespokojnie-pytal-o-ksiedza-plebana'),
('i-wolal-na-klucznika-zaklinam-wacpana'),
('abys-zostal-wnet-skoncze-ledwie-mam-dosc-mocy'),
('zakonczyc-panie-klucznik-ja-umre-tej-nocy'),
('co-bracie-krzyknal-sedzia-widzialem-wszak-rana'),
('niewielka-co-ty-mowisz-po-ksiedza-plebana'),
('moze-zle-opatrzono-zaraz-po-doktora'),
('mialem-tam-strzal-dawniejszy-dostalem-pod-jena'),
('zle-zgojony-a-teraz-drasniono-gangrena'),
('juz-tu-znam-sie-na-ranach-patrz-jaka-krew-czarna'),
('jak-sadza-co-tu-doktor-ale-to-rzecz-marna'),
('raz-umieramy-jutro-czy-dzis-oddac-dusze-'),
('panie-klucznik-przebaczysz-mnie-ja-skonczyc-musze'),
('jest-w-tym-zasluga-nie-chciec-zostac-winowajca'),
('narodowym-choc-narod-okrzyczy-cie-zdrajca'),
...
('nawet-lada-chlop-lada-zyd-choc-sie-poklonil'),
('to-mie-zboku-szyderskim-przebijal-usmiechem'),
...
('dano-soplicom-znaczna-czesc-dobr-nieboszczyka'),
('targowiczanie-potem-chcieli-mnie-zaszczycic'),
('urzedem-gdybym-wtenczas-chcial-sie-przemoskwicic'),
('szatan-radzil-juz-bylem-mozny-i-bogaty'),
('gdybym-zostal-moskalem-najpierwsze-magnaty'),
('szukalyby-mych-wzgledow-nawet-szlachta-braty'),
('nawet-gmin-ktory-swoim-tak-lacnie-uwlacza'),
('tym-ktorzy-moskwie-sluza-szczesliwszym-przebacza'),
('wiedzialem-to-a-przeciez-nie-moglem'),
('gdziem-nie-byl-com-nie-cierpial'),
('az-bog-raczyl-lekarstwo-jedyne-objawic'),
('poprawic-sie-potrzeba-bylo-i-naprawic'),
('corka-stolnika-ze-swym-mezem-wojewoda'),
('gdzies-w-sybir-wywieziona-tam-umarla-mlodo'),
('zostawila-te-w-kraju-corke-mala-zosie'),
('bardziej-nizli-z-milosci-moze-z-glupiej-pychy'),
...
('trzeba-bylo-okupic-dobrymi-przyklady'),
('ziemskiej-bieglem-tylekroc-na-miecze-na-strzaly'),
('milej-sobie-wspominam-nie-dziela-waleczne'),
('i-glosne-ale-czyny-ciche-uzyteczne'),
('udalo-mi-sie-nieraz-do-kraju-przedzierac'),
('rozkazy-wodzow-nosic-wiadomosci-zbierac'),
('ukladac-zmowy-znaja-i-galicyjanie'),
...
('w-carcer-durum-a-pan-bog-wybawil-mnie-cudem'),
('i-pozwolil-umierac-miedzy-swoim-ludem'),
('moze-i-teraz-kto-wie-mozem-znowu-zgrzeszyl'),
('mozem-nad-rozkaz-wodzow-powstanie-przyspieszyl'),
('ta-mysl-ze-dom-soplicow-pierwszy-sie-uzbroi'),
('ze-pierwsza-pogon-w-litwie-zatkna-krewni-moi'),
('chciales-zemsty-masz-bos-ty-byl-narzedziem-kary'),
('bozej-twoim-bog-mieczem-rozcial-me-zamiary'),
('tys-watek-spisku-tyle-lat-snowany-splatal'),
('cel-wielki-ktory-cale-zycie-me-zaprzatal'),
('ostatnie-moje-ziemskie-uczucie-na-swiecie'),
('ktorem-tulil-hodowal-jak-najmilsze-dziecie'),
('tys-zabil-w-oczach-ojca-a-jam-ci-przebaczyl'),
('oby-tylko-rownie-bog-przebaczyc-raczyl-'),
('przerwal-klucznik-jezeli-masz-przyjac-wijatyk'),
('ksieze-jacku-toc-ja-nie-luter-nie-syzmatyk'),
('kto-umierajacego-smuci-wiem-ze-grzeszy'),
('powiem-tobie-cos-pewnie-to-ciebie-pocieszy'),
('kiedy-nieboszczyk-pan-moj-upadal-zraniony'),
...
('mowic-nie-mogl-lecz-dal-znak-ze-zbojcy-przebaczyl'),
('ja-tez-pojalem-ale-tak-sie-z-gniewu-wscieklem'),
...
('jacek-bratu-oddaje-glosno-czytac-kaze'),
('list-od-fiszera-ktory-byl-natenczas-szefem'),
('sztabu-armii-polskiej-pod-ksieciem-jozefem'),
...
('wyrzekna-uroczyscie-przylaczenie-litwy'),
('jacek-sluchajac-cicho-odmowil-modlitwy'),
('przycisnawszy-do-piersi-swiecona-gromnice'),
('podniosl-w-niebo-zatlone-nadzieja-zrenice'),
('i-zalal-sie-ostatnich-lez-rozkosznych-zdrojem'),
('teraz-rzekl-panie-sluge-twego-pusc-z-pokojem'),
('wszyscy-uklekli-a-wtem-ozwal-sie-pod-progiem'),
('dzwonek-znak-ze-przyjechal-pleban-z-panem-bogiem'),
('wlasnie-juz-noc-schodzila-i-przez-niebo-mleczne'),
('rozowe-biega-pierwsze-promyki-sloneczne'),
...
('gromadzily-sie-ponad-wodami-jaskolki'),
...
('skad-w-krolestwie-skrzydlatym-tyle-zamieszania'),
...
('wszyscy-na-polnoc-rzeklbys-ze-w-on-czas-z-wyraju'),
...
('zlakl-sie-i-uciekl-w-glebszym-schowac-sie-ukryciu'),
...
('i-odpowiedna-wielkiej-dnia-uroczystosci'),
('co-jest-swietem-koscielnym-i-swietem-rodziny'),
...
('ksiega-ta-miala-tytul-kucharz-doskonaly'),
...
('gdy-przyjmowal-w-nieswiezu-krola-stanislawa'),
...
('zreszta-zas-mias-wszelakich-byl-wielki-dostatek'),
('co-sie-zgromadzic-dalo-i-z-domu-i-z-jatek'),
('i-z-lasow-i-z-sasiedztwa-z-bliska-i-z-daleka'),
('rzeklbys-ptasiego-tylko-nie-dostaje-mleka'),
('dwie-rzeczy-ktorych-hojny-pan-do-uczty-szuka'),
('lacza-sie-w-soplicowie-dostatek-i-sztuka'),
('*kwietnej*-pogoda-byla-przesliczna-czas-ranny'),
...
('tak-po-niezmiernym-niebie-szlo-samotne-slonce'),
...
('oltarz-obraz-a-nawet-dzwonica-i-ganki'),
...
('on-to-jacek-zwan-robak-wsrod-grotow-i-mieczy'),
...
('patrza-w-sad-gdzie-wsrod-paczkow-barwistego-maku'),
...
('toc-tym-samym-juz-wszystko-zgodzono-zgladzono'),
...
('taka-byla-zawzietosc-w-tym-malenkim-lichu'),
...
('wznoszac-glowe-i-patrzac-w-oczy-mu-niesmialo'),
...
('kuchcik-stuknal-don-w-okno-kota-spostrzezono'),
...
('a-charty-mu-siersc-biala-targaja-spod-brzucha'),
...
('wtem-rzekl-rejent-stawilem-niegdys-konia-z-rzedem'),
('opisalem-sie-takze-przed-ziemskim-urzedem'),
('iz-pierscien-moj-sedziemu-w-salarijum-zloze'),
...
('kuchcik-w-lat-kilka-pozniej-szepnal-o-tym-slowo'),
('chcac-assesora-sklocic-z-rejentem-na-nowo'),
...
('bo-dla-tych-wodzow-ktorzy-w-swym-zyciu-tulaczym'),
...
('gorset-takze-zielony-rozowymi-wstegi'),
...
('cesarz-go-pulkownikiem-dzis-wlasnie-mianowal'),
...
('tadeusz-i-zofia-do-stolu-nie-siedli'),
...
('za-czym-wojski-podnosi-laske-i-tak-prawi'),
...
('rak-niespokojnych-widac-mowca-cos-tlumaczy'),
...
('lecz-za-to-w-trzecim-gronie-dzieje-sie-inaczej'),
...
('widac-ze-kreske-swoja-kabale-powierzy'),
...
('to-przeor-sanktissimum-z-oltarza-wynosi'),
('a-chlopiec-w-komzy-dzwoni-i-na-ustep-prosi'),
...
('te-historie-prawda-ze-sejmik-ciekawy'),
...
('biedna-jasnie-wielmoznej-tytul-przybrac-miala'),
...
('na-koniec-owe-chwila-przedtem-strojne-drzewa'),
('teraz-jakby-odarte-od-wichrow-i-szronu'),
...
('mowiac-ze-to-machina-zmudna-staroswiecka'),
('ze-to-ma-pozor-niby-zabawki-dla-dziecka'),
('nieprzyzwoitej-dla-tak-znakomitych-ludzi'),
('sedzio-i-sedzia-mowil-ze-to-gosci-znudzi'),
('a-przeciez-ile-wnosze-z-panow-zadziwienia'),
('widze-iz-ten-kunszt-piekny-godzien-byl-widzenia'),
('nie-wiem-czy-sie-podobna-okazja-zdarzy'),
('czestowac-w-soplicowie-takich-dygnitarzy'),
('widze-ze-pan-jeneral-na-biesiadach-zna-sie'),
('niechaj-przyjmie-te-ksiazke-ona-panu-zda-sie'),
('gdy-bedziesz-dla-monarchow-zagranicznych-grona'),
('dawal-uczte-ba-nawet-dla-napoleona'),
('ale-pozwol-nim-ksiege-te-panu-poswiece'),
('niech-powiem-jakim-trafem-wpadla-w-moje-rece'),
('wtem-szmer-powstal-za-drzwiami-razem-glosow-wiele'),
('zawolalo-niech-zyje-kurek-na-kosciele'),
('cizba-tloczy-sie-w-sale-a-maciej-na-czele'),
('sedzia-goscia-za-reke-do-stolu-prowadzil'),
('i-wysoko-pomiedzy-wodzami-posadzil'),
('mowiac-panie-macieju-niedobry-sasiedzie'),
('przyjezdzasz-bardzo-pozno-prawie-po-obiedzie'),
('jem-wczesnie-rzekl-dobrzynski-ja-tu-nie-dla-jadla'),
('przybylem-tylko-ze-mnie-ciekawosc-napadla'),
('obejrzec-z-bliska-nasza-armia-narodowa'),
('wieleby-gadac-jest-to-ani-to-ni-owo'),
('szlachta-mnie-obaczyla-i-gwaltem-tu-wiedzie'),
('a-waszec-za-stol-sadzasz-dziekuje-sasiedzie'),
('to-wyrzeklszy-przewrocil-talerz-dnem-do-gory'),
('na-znak-ze-jesc-nie-bedzie-i-milczal-ponury'),
('panie-dobrzynski-rzekl-mu-jeneral-dabrowski'),
('tyz-to-jestes-ow-slawny-rebacz-kosciuszkowski'),
('ow-maciej-zwany-rozga-znam-ciebie-ze-slawy'),
('i-prosze-takis-dotad-czerstwy-taki-zwawy'),
('ilez-to-lat-minelo-patrz-jam-sie-podstarzal'),
('patrz-i-kniaziewiczowi-juz-sie-wlos-poszarzal'),
('a-ty-jeszcze-z-mlodymi-moglbys-pojsc-w-zapasy'),
('i-rozga-twoja-kwitnie-pono-jak-przed-czasy'),
('slyszalem-zes-niedawno-moskalow-ocwiczyl'),
('lecz-gdzie-sa-bracia-twoi-niezmiernie-bym-zyczyl'),
('widziec-te-scyzoryki-i-te-wasze-brzytwy'),
('ostatnie-egzemplarze-starodawnej-litwy'),
('jenerale-rzekl-sedzia-po-owym-zwyciestwie'),
('zapewne-do-ktorego-weszli-legionu'),
('w-istocie-odpowiedzial-mlody-szef-szwadronu-'),
('mam-w-drugiej-kompaniji-wasate-straszydlo'),
('wachmistrza-dobrzynskiego-co-sie-zwie-kropidlo'),
('a-mazury-zowia-go-litewskim-niedzwiedziem'),
('jesli-jeneral-kaze-to-go-tu-przywiedziem'),
('jest-rzekl-porucznik-kilku-innych-rodem-z-litwy'),
('jeden-zolnierz-znajomy-pod-imieniem-brzytwy'),
('i-drugi-co-z-tromblonem-jezdzi-na-flankiery'),
('sa-takze-w-pulku-strzelcow-dwa-grenadyjery'),
('rzekl-jeneral-chce-wiedziec-o-tym-scyzoryku'),
('o-ktorym-mnie-pan-wojski-tyle-prawil-cudow'),
('jakby-o-jednym-z-owych-dawnych-wielkoludow'),
('scyzoryk-rzecze-wojski-choc-nie-egzulowal'),
('ale-bojac-sie-sledztwa-przed-moskwa-sie-schowal'),
('cala-zime-nieborak-tulal-sie-po-lasach'),
('teraz-dopiero-wyszedl-w-tych-wojennych-czasach'),
('moglby-sie-na-co-przydac-jest-rycerskim-czlekiem'),
('szkoda-tylko-ze-troche-przycisniony-wiekiem'),
('lecz-owoz-on-tu-wojski-palcem-wskazal-w-sieni'),
('gdzie-czeladz-i-wiesniacy-stali-natloczeni'),
('a-nad-wszystkich-glowami-lysina-blyszczaca'),
('ukazala-sie-nagle-jak-pelnia-miesiaca'),
('trzykroc-weszla-i-trzykroc-znikla-w-glow-obloku'),
('klucznik-idac-klanial-sie-az-dobyl-sie-z-tloku'),
('jasnie-wielmozny-koronny-hetmanie'),
('czy-jenerale-mniejsza-o-tytulowanie'),
('jam-jest-rebajlo-staje-na-twe-zawolanie'),
('z-tym-moim-scyzorykiem-ktory-nie-z-oprawy'),
('ani-z-napisow-ale-z-hartu-nabyl-slawy'),
('ze-nawet-o-nim-jasnie-wielmozny-pan-wiedzial'),
('gdyby-on-gadac-umial-moze-by-powiedzial'),
('cokolwiek-na-pochwale-i-tej-starej-reki'),
('ktora-sluzyla-dlugo-wiernie-bogu-dzieki'),
('ojczyznie-tudziez-panow-horeszkow-rodzinie'),
('czego-pamiec-dotychczas-miedzy-ludzmi-slynie'),
('mopanku-rzadko-ktory-pisarz-prowentowy'),
('tak-zrecznie-temperuje-piora-jak-on-glowy'),
('dlugo-liczyc-a-nosow-i-uszu-bez-liku'),
('a-nie-ma-zadnej-szczerby-na-tym-scyzoryku'),
('i-zaden-go-nie-splamil-zbojecki-uczynek'),
('tylko-otwarta-wojna-albo-pojedynek'),
('raz-tylko-panie-daj-mu-wieczny-odpoczynek'),
('bezbronnego-czlowieka-niestety-sprzatniono'),
('a-i-to-bog-mi-swiadkiem-pro-publico-bono'),
('pokaz-no-rzekl-smiejac-sie-jeneral-dabrowski-'),
('a-to-piekny-scyzoryk-istny-miecz-katowski'),
('i-z-zadziwieniem-wielki-rapier-opatrywal'),
('i-innym-oficerom-w-kolej-pokazywal'),
('probowali-go-wszyscy-ale-ledwie-ktory'),
('z-oficerow-mogl-podniesc-ten-rapier-do-gory'),
('mowiono-ze-dembinski-slawny-reki-sila'),
('podzwignalby-szablice-lecz-go-tam-nie-bylo'),
('z-obecnych-zas-tylko-szef-szwadronu-dwernicki'),
('i-dowodca-plutonu-porucznik-rozycki'),
('potrafili-obracac-tym-zelaznym-dragiem'),
('i-tak-rapier-na-probe-szedl-z-rak-do-rak-ciagiem'),
('lecz-jeneral-kniaziewicz-wzrostem-najsluszniejszy'),
('pokazalo-sie-iz-byl-w-reku-najsilniejszy'),
('ujawszy-rapier-lekko-jakby-szpade-dzwignal'),
('i-nad-glowami-gosci-blyskawica-mignal'),
('przypominajac-polskie-fechtarskie-wykrety'),
('*krzyzowa-sztuke-mlynca-cios-krzywy-raz-ciety*'),
('*cios-kradziony*-i-tempy-*kontrpunktow-tercetow*'),
('ktore-tez-umial-bo-byl-ze-szkoly-kadetow'),
('gdy-smiejac-sie-fechtowal-rebajlo-juz-kleczal'),
('objal-go-za-kolana-i-ze-lzami-jeczal'),
('za-kazdym-zwrotem-miecza-pieknie-jenerale'),
('czys-byl-konfederatem-pieknie-doskonale'),
('to-sztych-sawy-ktoz-panu-tak-reke-ukladal'),
('chyba-maciej-dobrzynski-a-to-jenerale'),
('moj-wynalazek-dalbog-moj-ja-sie-nie-chwale'),
('to-ciecie-znane-tylko-w-rebajlow-zascianku'),
('od-mojego-imienia-zwane-*cios-mopanku*'),
('ktoz-to-pana-nauczyl-to-jest-moje-ciecie'),
('moje-wstal-jenerala-porwawszy-w-objecie'),
('teraz-umre-spokojny-jest-przecie-na-swiecie'),
('czlowiek-ktory-przytuli-moje-drogie-dziecie'),
('bo-wszak-nad-tym-od-dawna-dzien-i-noc-boleje'),
('czy-po-smierci-ten-rapier-moj-nie-zerdzewieje'),
('otoz-nie-zerdzewieje-moj-jasnie-wielmozny'),
('jenerale-wybacz-mi-porzuccie-te-rozny'),
('niemieckie-szpadki-to-wstyd-szlacheckiemu-dziecku'),
('nosic-ten-kijek-wezmij-szable-po-szlachecku'),
('oto-ten-moj-scyzoryk-u-nog-twoich-skladam'),
('to-jest-co-najdrozszego-na-swiecie-posiadam'),
('nie-mialem-nigdy-zony-nie-mialem-dzieciecia'),
('on-byl-zona-i-dzieckiem-z-mojego-objecia'),
('nigdy-on-nie-wychodzil-od-rana-do-mroku'),
('piescilem-go-on-w-nocy-sypial-przy-mym-boku'),
('a-kiedym-sie-zestarzal-nad-lozkiem-na-scianie'),
('wisial-jako-nad-zydem-boze-przykazanie'),
('myslilem-zakopac-go-razem-z-reka-w-grobie'),
('lecz-znalazlem-dziedzica-niechaj-sluzy-tobie'),
('jeneral-wpol-smiejac-sie-a-na-wpol-wzruszony'),
('kolego-rzekl-jezeli-ustapisz-mnie-zony'),
('i-dziecka-to-zostaniesz-przez-reszte-zywota'),
('bardzo-samotny-stary-wdowiec-i-sierota'),
('powiedz-czym-ci-ten-drogi-dar-mam-wynagrodzic'),
('i-czym-twoje-sieroctwo-i-wdowstwo-oslodzic'),
('czy-ja-cybulski-rzecze-na-to-klucznik-z-zalem-'),
('co-zone-przegral-grajac-w-mariasza-z-moskalem-'),
('jak-o-tym-piesn-powiada-ja-mam-dosyc-na-tem'),
('ze-moj-scyzoryk-jeszcze-zablysnie-przed-swiatem'),
('w-takim-reku-niech-tylko-jeneral-pamieta'),
('aby-tasiemka-byla-dluga-rozciagnieta'),
('bo-to-dlugie-a-zawsze-od-lewego-ucha'),
('ciac-oburacz-to-przetniesz-od-glowy-do-brzucha'),
('jeneral-wzial-scyzoryk-lecz-ze-bardzo-dlugi'),
('nie-mogl-nosic-w-furgonie-schowaly-go-slugi'),
('co-sie-z-nim-stalo-roznie-powiadaja-o-tem'),
('dabrowski-rzekl-do-macka-a-ty-co-kolego'),
('zdaje-sie-zes-ty-nie-rad-z-przybycia-mojego'),
('milczysz-kwasny-i-jakze-serce-ci-nie-skacze'),
('gdy-widzisz-orly-zlote-srebrne-gdy-trebacze'),
('pobudke-kosciuszkowska-trabia-ci-nad-uchem'),
('macku-myslilem-ze-ty-wiekszym-jestes-zuchem'),
('jesli-szabli-nie-wezmiesz-i-na-kon-nie-siedziesz'),
('przynajmniej-z-kolegami-wesolo-pic-bedziesz'),
('zdrowie-napoleona-i-polski-nadzieje'),
('ha-rzekl-maciej-slyszalem-widze-co-sie-dzieje'),
('ale-panie-dwoch-orlow-razem-sie-nie-gniezdzi'),
('laska-panska-hetmanie-na-pstrym-koniu-jezdzi'),
('cesarz-wielki-bohater-gadac-o-tym-wiele'),
('pamietam-ze-pulascy-moi-przyjaciele'),
('mawiali-pogladajac-na-dymuliera'),
('ze-dla-polski-polskiego-trzeba-bohatera'),
('nie-francuza-ani-tez-wlocha-ale-piasta'),
('jana-albo-jozefa-lub-macka-i-basta'),
('wojsko-mowia-ze-polskie-lecz-te-fizyliery'),
('wiecej-slychac-niemieckich-tytulow-w-tym-tlumie'),
('nizeli-narodowych-kto-to-juz-zrozumie'),
('a-musza-tez-byc-z-wami-turki-czy-tatary'),
...
('wszytko-to-jest-tu-maciej-chleb-umoczyl-w-zupie'),
('i-jedzac-nie-dokonczyl-ostatniego-slowa'),
('nie-w-smak-podkomorzemu-poszla-macka-mowa'),
('mlodziez-zaczela-szemrac-sedzia-przerwal-swary'),
('gloszac-przybycie-trzeciej-narzeczonej-pary'),
('byl-to-rejent-sam-siebie-rejentem-oglosil'),
('nikt-go-nie-poznal-dotad-polskie-suknie-nosil'),
('lecz-teraz-telimena-przyszla-zona-zmusza'),
('warunkiem-intercyzy-wyrzec-sie-kontusza-'),
('wiec-sie-rejent-rad-nierad-po-francusku-przebral'),
('widno-ze-mu-frak-duszy-polowe-odebral'),
('stapa-jakby-kij-polknal-prosto-nieruchawo'),
('jak-zuraw-nie-smie-spojrzec-ni-w-lewo-ni-w-prawo'),
('mina-gesta-lecz-z-miny-widac-ze-jest-w-mece'),
('nie-wie-jak-sie-poklonic-gdzie-ma-podziac-rece'),
('on-co-tak-gesty-lubil-rece-za-pas-sadzil'),
('nie-masz-pasa-tylko-sie-po-zoladku-gladzil'),
('postrzegl-omylke-bardzo-zmieszal-sie-spiekl-raka'),
('i-rece-obie-schowal-w-jedna-kieszen-fraka'),
('idzie-jakby-przez-rozgi-srod-szeptow-i-drwinek'),
('wstydzac-sie-za-frak-jakby-za-niecny-uczynek'),
('az-spotkal-oczy-macka-i-zadrzal-z-bojazni'),
('maciej-dotad-z-rejentem-zyl-w-wielkiej-przyjazni'),
('teraz-wzrok-nan-obrocil-tak-ostry-i-dziki'),
('ze-rejent-zbladnal-zaczal-zapinac-guziki'),
('myslac-ze-maciej-wzrokiem-suknie-z-niego-zlupi'),
('dobrzynski-tylko-dwakroc-wyrzekl-glosno-glupi'),
('i-tak-strasznie-zgorszyl-sie-z-rejenta-przebrania'),
('ze-zaraz-wstal-od-stolu-i-bez-pozegnania'),
('wymknawszy-sie-wsiadl-na-kon-wrocil-do-zascianka'),
('a-tymczasem-rejenta-nadobna-kochanka'),
('telimena-roztacza-blaski-swej-urody'),
('i-ubior-od-stop-do-glow-co-najswiezszej-mody'),
('jaka-miala-sukienke-jaki-stroj-na-glowie'),
('daremnie-pisac-pioro-tego-nie-wypowie'),
('chyba-pedzel-by-skreslil-te-tiule-ptyfenie'),
('blondyny-kaszemiry-perly-i-kamienie'),
('i-oblicze-rozane-i-zywe-wejrzenie'),
('poznal-ja-zaraz-hrabia-z-zadziwienia-blady'),
('wstal-od-stolu-i-szukal-kolo-siebie-szpady'),
('i-tyzes-to-zawolal-czy-mnie-oczy-ludza'),
('ty-w-obecnosci-mojej-sciskasz-reke-cudza'),
('o-niewierna-istoto-o-duszo-zmiennicza'),
('i-nie-skryjesz-ze-wstydu-pod-ziemie-oblicza'),
('takes-twojej-tak-swiezej-niepomna-przysiegi'),
('o-latwowierny-po-coz-nosilem-te-wstegi'),
('lecz-biada-rywalowi-co-mie-tak-zniewaza'),
('po-moim-chyba-trupie-pojdzie-do-oltarza'),
('goscie-powstali-rejent-okropnie-sie-zmieszal'),
('podkomorzy-rywalow-zagodzic-pospieszal'),
('lecz-telimena-wziawszy-hrabiego-na-strone'),
('jeszcze-szepnela-rejent-nie-wzial-mie-za-zone'),
('jezeli-pan-przeszkadzasz-odpowiedzze-na-to'),
('a-odpowiedz-mi-zaraz-krotko-wezlowato'),
('czy-mnie-kochasz-czys-dotad-serca-nie-odmienil'),
('czys-gotow-zebys-ze-mna-zaraz-sie-ozenil'),
('zaraz-dzis-jesli-zechcesz-odstapie-rejenta'),
('hrabia-rzekl-o-kobieto-dla-mnie-niepojeta'),
('dawniej-w-uczuciach-twoich-bylas-poetyczna'),
('a-teraz-mi-sie-zdajesz-calkiem-prozaiczna'),
('coz-sa-wasze-malzenstwa-jesli-nie-lancuchy'),
('ktore-zwiazuja-tylko-rece-a-nie-duchy'),
('wierzaj-sa-oswiadczenia-nawet-bez-wyznania'),
('sa-obowiazki-nawet-bez-obowiazania'),
('dwa-serca-palajace-na-dwoch-koncach-ziemi'),
('rozmawiaja-jak-gwiazdy-promienmi-drzacemi'),
('kto-wie-moze-dla-tego-ziemia-tak-do-slonca'),
('dazy-i-tak-jest-zawsze-mila-dla-miesiaca'),
('ze-wiecznie-patrza-na-sie-i-najkrotsza-droga'),
('biega-do-siebie-ale-zblizyc-sie-nie-moga'),
('dosc-juz-tego-przerwala-nie-jestem-planeta'),
('z-laski-bozej-dosc-hrabio-ja-jestem-kobieta'),
('juz-wiem-reszte-przestan-mi-plesc-ni-to-ni-owo'),
('teraz-ostrzegam-jesli-pisniesz-jedno-slowo'),
('azeby-slub-moj-zerwac-to-jak-bog-na-niebie'),
('ze-z-tymi-paznokciami-przyskocze-do-ciebie'),
('i-nie-bede-rzekl-hrabia-szczescia-pani-klocil'),
('i-oczy-pelne-smutku-i-wzgardy-odwrocil'),
('i-azeby-ukarac-niewierna-kochanke'),
('za-przedmiot-stalych-ogniow-wzial-podkomorzanke'),
('wojski-pragnal-mlodziencow-poroznionych-zgodzic'),
('przykladami-madrymi-wiec-zaczal-wywodzic'),
('historyje-o-dziku-nalibockich-lasow'),
('i-o-klotni-rejtana-z-ksiezeciem-denassow'),
('ale-goscie-tymczasem-skonczyli-jesc-lody'),
('i-z-zamku-na-dziedziniec-wyszli-dla-ochlody'),
('tam-wlosc-juz-konczy-uczte-kraza-miodu-dzbany'),
('muzyka-juz-sie-stroi-i-wzywa-na-tany'),
('szukaja-tadeusza-ktory-stal-na-stronie'),
('i-cos-pilnego-szeptal-swojej-przyszlej-zonie'),
('zofio-musze-ciebie-w-bardzo-waznej-rzeczy'),
('radzic-sie-juz-pytalem-stryja-on-nie-przeczy'),
('wiesz-iz-znaczna-czesc-wiosek-ktore-mam-posiadac'),
('wedle-prawa-na-ciebie-powinna-by-spadac'),
('ci-chlopi-sa-nie-moi-lecz-twoi-poddani'),
('nie-smialbym-ich-urzadzic-bez-woli-ich-pani'),
('teraz-kiedy-juz-mamy-ojczyzne-kochana'),
('czyliz-wiesniacy-zyszcza-z-ta-szczesliwa-zmiana'),
('tyle-tylko-ze-pana-innego-dostana'),
('prawda-ze-byli-dotad-rzadzeni-laskawie'),
('lecz-po-mej-smierci-bog-wie-komu-ich-zostawie'),
('jestem-zolnierz-jestesmy-smiertelni-oboje'),
('jestem-czlowiek-sam-wlasnych-kaprysow-sie-boje'),
('bezpieczniej-zrobie-kiedy-wladzy-sie-wyrzeke'),
('i-oddam-los-wloscianow-pod-prawa-opieke'),
('sami-wolni-uczynmy-i-wloscian-wolnemi'),
('oddajmy-im-w-dziedzictwo-posiadanie-ziemi'),
('na-ktorej-sie-zrodzili-ktora-krwawa-praca'),
('zdobyli-z-ktorej-wszystkich-zywia-i-bogaca'),
('lecz-musze-ciebie-ostrzec-ze-tych-ziem-nadanie'),
('zmniejszy-nasz-dochod-w-miernym-musimy-zyc-stanie'),
('ja-przywyklem-do-zycia-oszczednego-z-mlodu'),
('lecz-ty-zofio-jestes-z-wysokiego-rodu'),
...
('gdy-powaznymi-kroki-przystapil-protazy'),
...
('wolnych-rownych-polakow-wnosze-ludu-zdrowie'),
...
('nie-wyrowna-w-bieglosci-w-guscie-i-talencie'),
...
('klada-mu-na-kolanach-on-patrzy-z-rozkosza'),
...
('jankiel-z-przymruzonymi-na-poly-oczyma'),
('milczy-i-nieruchome-drazki-w-palcach-trzyma'),
('spuscil-je-zrazu-bijac-taktem-tryumfalnym'),
('potem-gesciej-siekl-struny-jak-deszczem-nawalnym'),
('dziwia-sie-wszyscy-lecz-to-byla-tylko-proba'),
('bo-wnet-przerwal-i-w-gore-podniosl-drazki-oba'),
('znow-gra-juz-drza-drazki-tak-lekkimi-ruchy'),
('jak-gdyby-zadzwonilo-w-strune-skrzydlo-muchy'),
...
('*rzez-pragi*-ktora-znaly-z-piesni-i-z-powiesci'),
('rade-ze-mistrz-na-koniec-strunami-wszystkiemi'),
...
('lekkie-i-ciche-kilka-cienkich-strunek-jeczy'),
('jak-kilka-much-gdy-z-siatki-wyrwa-sie-pajeczej'),
('lecz-strun-coraz-przybywa-juz-rozpierzchle-tony'),
('lacza-sie-i-akordow-wiaza-legijony'),
('i-juz-w-takt-postepuja-zgodzonymi-dzwieki'),
...
('ze-struny-zadzwonily-jak-traby-mosiezne'),
...
('zyj-i-wojuj-o-ty-nasz-mowiac-ciagle-szlochal'),
...
('i-wasa-pokrecajac-podal-reke-zosi'),
...
('on-krok-zwalnia-oczyma-jej-spojrzenia-sledzi'),
...
('az-wlozyl-ja-na-bakier-i-pokrecil-wasa'),
...
('i-zewszad-obwijaja-tanecznymi-skrety'),
...
('nie-dziw-ze-ludzi-swiat-siebie-ohydza'),
...
('z-kilka-przyjaciol-siadlszy-przy-kominie'),
('drzwi-od-europy-zamykal-halasow'),
('wyrwal-sie-mysla-do-szczesliwszych-czasow'),
('i-dumal-marzyl-o-swojej-krainie'),
('ale-o-krwi-tej-co-sie-swiezo-lala'),
('o-lzach-ktorymi-plynie-polska-cala'),
...
('tam-mysl-nie-smiala-swoich-zwrocic-lotow'),
('w-sfere-okropna-nawet-ptakom-grzmotow'),
('o-matko-polsko-ty-tak-swiezo-w-grobie'),
('zlozona-nie-masz-sil-mowic-o-tobie'),
('ach-czyjez-usta-smia-pochlebiac-sobie'),
('ze-znajda-dzisiaj-to-czarowne-slowo'),
('ktore-rozczuli-rozpacz-marmurowa'),
...
('cial-sie-najedza-krwia-cale-oplyna'),
('i-skrzydla-wreszcie-na-spoczynek-zwina'),
('gdy-wrog-ostatni-wyda-krzyk-bolesci'),
('umilknie-swiatu-swobode-obwiesci-'),
('wtenczas-debowym-lisciem-uwienczeni'),
('rzuciwszy-miecze-sieda-rozbrojeni'),
('rycerze-nasi-zechca-sluchac-o-przeszlosci'),
...
('jedna-juz-tylko-dzis-kraina-taka'),
('w-ktorej-jest-troche-szczescia-dla-polaka'),
('kraj-lat-dziecinnych-on-zawsze-zostanie'),
('swiety-i-czysty-jak-pierwsze-kochanie'),
('niezaburzony-bledow-przypomnieniem'),
('niepodkopany-nadziei-zludzeniem'),
...
('jak-kazdy-kacik-ziemi-byl-znajomy'),
('a-jesli-czasem-i-moskal-sie-zjawil'),
('tyle-nam-tylko-pamiatki-zostawil'),
('ze-byl-w-blyszczacym-i-pieknym-mundurze'),
('bo-weza-tylko-znalismy-po-skorze'),
...
('jakze-tam-o-nim-czule-sie-mowilo'),
...
('i-do-piesni-rzucali-mi-slowo-po-slowie'),
('jak-bajeczne-zurawie-na-dzikim-ostrowie'),
('nad-zakletym-palacem-przelatujac-wiosna'),
('i-slyszac-zakletego-chlopca-skarge-glosna'),
('kazdy-ptak-chlopcu-jedno-pioro-rzucil'),
...
('zaganiac-ptastwo-szla-w-wieczornej-porze'),
...
('a-przy-stoliku-drewnianym-pan-wlodarz'),
...
('wianek-rekami-wiesniaczki-usnuty'),
